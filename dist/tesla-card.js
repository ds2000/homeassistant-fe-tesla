var ds=Object.defineProperty;var ps=(a,t,e)=>t in a?ds(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var Et=(a,t,e)=>ps(a,typeof t!="symbol"?t+"":t,e);var yt=globalThis,xt=yt.ShadowRoot&&(yt.ShadyCSS===void 0||yt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Pt=Symbol(),ve=new WeakMap,et=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==Pt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(xt&&t===void 0){let s=e!==void 0&&e.length===1;s&&(t=ve.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&ve.set(e,t))}return t}toString(){return this.cssText}},Ee=a=>new et(typeof a=="string"?a:a+"",void 0,Pt),k=(a,...t)=>{let e=a.length===1?a[0]:t.reduce((s,i,n)=>s+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+a[n+1],a[0]);return new et(e,a,Pt)},ye=(a,t)=>{if(xt)a.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of t){let s=document.createElement("style"),i=yt.litNonce;i!==void 0&&s.setAttribute("nonce",i),s.textContent=e.cssText,a.appendChild(s)}},Gt=xt?a=>a:a=>a instanceof CSSStyleSheet?(t=>{let e="";for(let s of t.cssRules)e+=s.cssText;return Ee(e)})(a):a;var{is:ms,defineProperty:us,getOwnPropertyDescriptor:_s,getOwnPropertyNames:gs,getOwnPropertySymbols:fs,getPrototypeOf:bs}=Object,T=globalThis,xe=T.trustedTypes,vs=xe?xe.emptyScript:"",Es=T.reactiveElementPolyfillSupport,st=(a,t)=>a,zt={toAttribute(a,t){switch(t){case Boolean:a=a?vs:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,t){let e=a;switch(t){case Boolean:e=a!==null;break;case Number:e=a===null?null:Number(a);break;case Object:case Array:try{e=JSON.parse(a)}catch{e=null}}return e}},we=(a,t)=>!ms(a,t),ke={attribute:!0,type:String,converter:zt,reflect:!1,useDefault:!1,hasChanged:we};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),T.litPropertyMetadata??(T.litPropertyMetadata=new WeakMap);var R=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=ke){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let s=Symbol(),i=this.getPropertyDescriptor(t,s,e);i!==void 0&&us(this.prototype,t,i)}}static getPropertyDescriptor(t,e,s){let{get:i,set:n}=_s(this.prototype,t)??{get(){return this[e]},set(r){this[e]=r}};return{get:i,set(r){let p=i?.call(this);n?.call(this,r),this.requestUpdate(t,p,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??ke}static _$Ei(){if(this.hasOwnProperty(st("elementProperties")))return;let t=bs(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(st("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(st("properties"))){let e=this.properties,s=[...gs(e),...fs(e)];for(let i of s)this.createProperty(i,e[i])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[s,i]of e)this.elementProperties.set(s,i)}this._$Eh=new Map;for(let[e,s]of this.elementProperties){let i=this._$Eu(e,s);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let s=new Set(t.flat(1/0).reverse());for(let i of s)e.unshift(Gt(i))}else t!==void 0&&e.push(Gt(t));return e}static _$Eu(t,e){let s=e.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,e=this.constructor.elementProperties;for(let s of e.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ye(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$ET(t,e){let s=this.constructor.elementProperties.get(t),i=this.constructor._$Eu(t,s);if(i!==void 0&&s.reflect===!0){let n=(s.converter?.toAttribute!==void 0?s.converter:zt).toAttribute(e,s.type);this._$Em=t,n==null?this.removeAttribute(i):this.setAttribute(i,n),this._$Em=null}}_$AK(t,e){let s=this.constructor,i=s._$Eh.get(t);if(i!==void 0&&this._$Em!==i){let n=s.getPropertyOptions(i),r=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:zt;this._$Em=i;let p=r.fromAttribute(e,n.type);this[i]=p??this._$Ej?.get(i)??p,this._$Em=null}}requestUpdate(t,e,s,i=!1,n){if(t!==void 0){let r=this.constructor;if(i===!1&&(n=this[t]),s??(s=r.getPropertyOptions(t)),!((s.hasChanged??we)(n,e)||s.useDefault&&s.reflect&&n===this._$Ej?.get(t)&&!this.hasAttribute(r._$Eu(t,s))))return;this.C(t,e,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:s,reflect:i,wrapped:n},r){s&&!(this._$Ej??(this._$Ej=new Map)).has(t)&&(this._$Ej.set(t,r??e??this[t]),n!==!0||r!==void 0)||(this._$AL.has(t)||(this.hasUpdated||s||(e=void 0),this._$AL.set(t,e)),i===!0&&this._$Em!==t&&(this._$Eq??(this._$Eq=new Set)).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(let[i,n]of this._$Ep)this[i]=n;this._$Ep=void 0}let s=this.constructor.elementProperties;if(s.size>0)for(let[i,n]of s){let{wrapped:r}=n,p=this[i];r!==!0||this._$AL.has(i)||p===void 0||this.C(i,void 0,n,p)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(e)):this._$EM()}catch(s){throw t=!1,this._$EM(),s}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&(this._$Eq=this._$Eq.forEach(e=>this._$ET(e,this[e]))),this._$EM()}updated(t){}firstUpdated(t){}};R.elementStyles=[],R.shadowRootOptions={mode:"open"},R[st("elementProperties")]=new Map,R[st("finalized")]=new Map,Es?.({ReactiveElement:R}),(T.reactiveElementVersions??(T.reactiveElementVersions=[])).push("2.1.2");var at=globalThis,Ae=a=>a,kt=at.trustedTypes,Re=kt?kt.createPolicy("lit-html",{createHTML:a=>a}):void 0,Me="$lit$",O=`lit$${Math.random().toFixed(9).slice(2)}$`,Le="?"+O,ys=`<${Le}>`,G=document,nt=()=>G.createComment(""),rt=a=>a===null||typeof a!="object"&&typeof a!="function",Yt=Array.isArray,xs=a=>Yt(a)||typeof a?.[Symbol.iterator]=="function",Ft=`[ 	
\f\r]`,it=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,$e=/-->/g,Ce=/>/g,U=RegExp(`>|${Ft}(?:([^\\s"'>=/]+)(${Ft}*=${Ft}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Se=/'/g,Te=/"/g,Ne=/^(?:script|style|textarea|title)$/i,Kt=a=>(t,...e)=>({_$litType$:a,strings:t,values:e}),o=Kt(1),js=Kt(2),Qs=Kt(3),$=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),Oe=new WeakMap,P=G.createTreeWalker(G,129);function Ie(a,t){if(!Yt(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return Re!==void 0?Re.createHTML(t):t}var ks=(a,t)=>{let e=a.length-1,s=[],i,n=t===2?"<svg>":t===3?"<math>":"",r=it;for(let p=0;p<e;p++){let h=a[p],_,u,m=-1,g=0;for(;g<h.length&&(r.lastIndex=g,u=r.exec(h),u!==null);)g=r.lastIndex,r===it?u[1]==="!--"?r=$e:u[1]!==void 0?r=Ce:u[2]!==void 0?(Ne.test(u[2])&&(i=RegExp("</"+u[2],"g")),r=U):u[3]!==void 0&&(r=U):r===U?u[0]===">"?(r=i??it,m=-1):u[1]===void 0?m=-2:(m=r.lastIndex-u[2].length,_=u[1],r=u[3]===void 0?U:u[3]==='"'?Te:Se):r===Te||r===Se?r=U:r===$e||r===Ce?r=it:(r=U,i=void 0);let b=r===U&&a[p+1].startsWith("/>")?" ":"";n+=r===it?h+ys:m>=0?(s.push(_),h.slice(0,m)+Me+h.slice(m)+O+b):h+O+(m===-2?p:b)}return[Ie(a,n+(a[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]},ot=class a{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let n=0,r=0,p=t.length-1,h=this.parts,[_,u]=ks(t,e);if(this.el=a.createElement(_,s),P.currentNode=this.el.content,e===2||e===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(i=P.nextNode())!==null&&h.length<p;){if(i.nodeType===1){if(i.hasAttributes())for(let m of i.getAttributeNames())if(m.endsWith(Me)){let g=u[r++],b=i.getAttribute(m).split(O),x=/([.?@])?(.*)/.exec(g);h.push({type:1,index:n,name:x[2],strings:b,ctor:x[1]==="."?Vt:x[1]==="?"?jt:x[1]==="@"?Qt:Q}),i.removeAttribute(m)}else m.startsWith(O)&&(h.push({type:6,index:n}),i.removeAttribute(m));if(Ne.test(i.tagName)){let m=i.textContent.split(O),g=m.length-1;if(g>0){i.textContent=kt?kt.emptyScript:"";for(let b=0;b<g;b++)i.append(m[b],nt()),P.nextNode(),h.push({type:2,index:++n});i.append(m[g],nt())}}}else if(i.nodeType===8)if(i.data===Le)h.push({type:2,index:n});else{let m=-1;for(;(m=i.data.indexOf(O,m+1))!==-1;)h.push({type:7,index:n}),m+=O.length-1}n++}}static createElement(t,e){let s=G.createElement("template");return s.innerHTML=t,s}};function j(a,t,e=a,s){if(t===$)return t;let i=s!==void 0?e._$Co?.[s]:e._$Cl,n=rt(t)?void 0:t._$litDirective$;return i?.constructor!==n&&(i?._$AO?.(!1),n===void 0?i=void 0:(i=new n(a),i._$AT(a,e,s)),s!==void 0?(e._$Co??(e._$Co=[]))[s]=i:e._$Cl=i),i!==void 0&&(t=j(a,i._$AS(a,t.values),i,s)),t}var Bt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??G).importNode(e,!0);P.currentNode=i;let n=P.nextNode(),r=0,p=0,h=s[0];for(;h!==void 0;){if(r===h.index){let _;h.type===2?_=new lt(n,n.nextSibling,this,t):h.type===1?_=new h.ctor(n,h.name,h.strings,this,t):h.type===6&&(_=new Wt(n,this,t)),this._$AV.push(_),h=s[++p]}r!==h?.index&&(n=P.nextNode(),r++)}return P.currentNode=G,i}p(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},lt=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=j(this,t,e),rt(t)?t===f||t==null||t===""?(this._$AH!==f&&this._$AR(),this._$AH=f):t!==this._$AH&&t!==$&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):xs(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==f&&rt(this._$AH)?this._$AA.nextSibling.data=t:this.T(G.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:s}=t,i=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=ot.createElement(Ie(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{let n=new Bt(i,this),r=n.u(this.options);n.p(e),this.T(r),this._$AH=n}}_$AC(t){let e=Oe.get(t.strings);return e===void 0&&Oe.set(t.strings,e=new ot(t)),e}k(t){Yt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,i=0;for(let n of t)i===e.length?e.push(s=new a(this.O(nt()),this.O(nt()),this,this.options)):s=e[i],s._$AI(n),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let s=Ae(t).nextSibling;Ae(t).remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},Q=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,n){this.type=1,this._$AH=f,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=f}_$AI(t,e=this,s,i){let n=this.strings,r=!1;if(n===void 0)t=j(this,t,e,0),r=!rt(t)||t!==this._$AH&&t!==$,r&&(this._$AH=t);else{let p=t,h,_;for(t=n[0],h=0;h<n.length-1;h++)_=j(this,p[s+h],e,h),_===$&&(_=this._$AH[h]),r||(r=!rt(_)||_!==this._$AH[h]),_===f?t=f:t!==f&&(t+=(_??"")+n[h+1]),this._$AH[h]=_}r&&!i&&this.j(t)}j(t){t===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Vt=class extends Q{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===f?void 0:t}},jt=class extends Q{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==f)}},Qt=class extends Q{constructor(t,e,s,i,n){super(t,e,s,i,n),this.type=5}_$AI(t,e=this){if((t=j(this,t,e,0)??f)===$)return;let s=this._$AH,i=t===f&&s!==f||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,n=t!==f&&(s===f||i);i&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Wt=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){j(this,t)}};var ws=at.litHtmlPolyfillSupport;ws?.(ot,lt),(at.litHtmlVersions??(at.litHtmlVersions=[])).push("3.3.2");var De=(a,t,e)=>{let s=e?.renderBefore??t,i=s._$litPart$;if(i===void 0){let n=e?.renderBefore??null;s._$litPart$=i=new lt(t.insertBefore(nt(),n),n,void 0,e??{})}return i._$AI(a),i};var ct=globalThis,E=class extends R{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=De(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return $}};E._$litElement$=!0,E.finalized=!0,ct.litElementHydrateSupport?.({LitElement:E});var As=ct.litElementPolyfillSupport;As?.({LitElement:E});(ct.litElementVersions??(ct.litElementVersions=[])).push("4.2.2");var He={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ue=a=>(...t)=>({_$litDirective$:a,values:t}),wt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var ht=class extends wt{constructor(t){if(super(t),this.it=f,t.type!==He.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===f||t==null)return this._t=void 0,this.it=t;if(t===$)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;let e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};ht.directiveName="unsafeHTML",ht.resultType=1;var c=Ue(ht);var M=k`
  :host {
    display: block;
...
`;var dt={BATTERY_LEVEL:"sensor.{car_name}_battery_level",BATTERY_RANGE:"sensor.{car_name}_battery_range",CHARGE_RATE:"sensor.{car_name}_charge_rate",CHARGE_LIMIT:"number.{car_name}_charge_limit",CHARGING_STATE:"sensor.{car_name}_charging",TEMPERATURE_INSIDE:"sensor.{car_name}_inside_temperature",TEMPERATURE_OUTSIDE:"sensor.{car_name}_outside_temperature",SPEED:"sensor.{car_name}_speed",ODOMETER:"sensor.{car_name}_odometer",CHARGING:"switch.{car_name}_charge",PLUGGED_IN:"binary_sensor.{car_name}_charge_cable",PARKING_BRAKE:null,FRUNK:null,TRUNK:null,DOORS:null,WINDOWS:null,LOCKED:null,ONLINE:"binary_sensor.{car_name}_status",SENTRY_MODE:"switch.{car_name}_sentry_mode",DOOR_DRIVER_FRONT:"binary_sensor.{car_name}_front_driver_door",DOOR_DRIVER_REAR:"binary_sensor.{car_name}_rear_driver_door",DOOR_PASSENGER_FRONT:"binary_sensor.{car_name}_front_passenger_door",DOOR_PASSENGER_REAR:"binary_sensor.{car_name}_rear_passenger_door",WINDOW_DRIVER_FRONT:"binary_sensor.{car_name}_front_driver_window",WINDOW_DRIVER_REAR:"binary_sensor.{car_name}_rear_driver_window",WINDOW_PASSENGER_FRONT:"binary_sensor.{car_name}_front_passenger_window",WINDOW_PASSENGER_REAR:"binary_sensor.{car_name}_rear_passenger_window",DOOR_LOCK:"lock.{car_name}_lock",CHARGER_SWITCH:"switch.{car_name}_charge",SENTRY_MODE_SWITCH:"switch.{car_name}_sentry_mode",DEFROST_SWITCH:"switch.{car_name}_defrost",CAMP_MODE:null,DOG_MODE:null,CABIN_OVERHEAT:"climate.{car_name}_cabin_overheat_protection",HEATED_SEAT_LEFT:"select.{car_name}_seat_heater_front_left",HEATED_SEAT_RIGHT:"select.{car_name}_seat_heater_front_right",HEATED_SEAT_REAR_LEFT:"select.{car_name}_seat_heater_rear_left",HEATED_SEAT_REAR_CENTER:"select.{car_name}_seat_heater_rear_center",HEATED_SEAT_REAR_RIGHT:"select.{car_name}_seat_heater_rear_right",STEERING_WHEEL_HEATER:"select.{car_name}_steering_wheel_heater",AUTO_STEERING_WHEEL_HEATER:"switch.{car_name}_auto_steering_wheel_heater",CLIMATE:"climate.{car_name}_climate",CHARGE_LIMIT_NUMBER:"number.{car_name}_charge_limit",CHARGING_AMPS_NUMBER:"number.{car_name}_charge_current",CHARGE_PORT_OPEN:"cover.{car_name}_charge_port_door",CHARGE_PORT_CLOSE:"cover.{car_name}_charge_port_door",HORN:"button.{car_name}_honk_horn",FLASH_LIGHTS:"button.{car_name}_flash_lights",REMOTE_START:"button.{car_name}_keyless_driving",OPEN_FRUNK:"cover.{car_name}_froot",OPEN_TRUNK:"cover.{car_name}_boot",FORCE_UPDATE:"button.{car_name}_wake",WINDOWS_COVER:"cover.{car_name}_vent_windows",FRUNK_COVER:"cover.{car_name}_froot",CHARGER_DOOR:"cover.{car_name}_charge_port_door",ENERGY_ADDED:"sensor.{car_name}_charge_energy_added",TYRE_FL:"sensor.{car_name}_tyre_pressure_front_left",TYRE_FR:"sensor.{car_name}_tyre_pressure_front_right",TYRE_RL:"sensor.{car_name}_tyre_pressure_rear_left",TYRE_RR:"sensor.{car_name}_tyre_pressure_rear_right",TIME_TO_FULL_CHARGE:"sensor.{car_name}_time_to_full_charge",DISTANCE_TO_ARRIVAL:"sensor.{car_name}_distance_to_arrival",TIME_TO_ARRIVAL:"sensor.{car_name}_time_to_arrival",LOCATION:"device_tracker.{car_name}_location",ROUTE:"device_tracker.{car_name}_route"},Rs={BATTERY_LEVEL:"sensor.{car_name}_battery",BATTERY_RANGE:"sensor.{car_name}_battery_range",CHARGE_RATE:"sensor.{car_name}_charge_rate",CHARGE_LIMIT:"sensor.{car_name}_charge_limit",CHARGING_STATE:"sensor.{car_name}_charging_state",TEMPERATURE_INSIDE:"sensor.{car_name}_temperature_inside",TEMPERATURE_OUTSIDE:"sensor.{car_name}_temperature_outside",SPEED:"sensor.{car_name}_speed",ODOMETER:"sensor.{car_name}_odometer",CHARGING:"binary_sensor.{car_name}_charging",PLUGGED_IN:"binary_sensor.{car_name}_plugged_in",PARKING_BRAKE:"binary_sensor.{car_name}_parking_brake",FRUNK:"binary_sensor.{car_name}_frunk",TRUNK:"binary_sensor.{car_name}_trunk",DOORS:"binary_sensor.{car_name}_doors",WINDOWS:"binary_sensor.{car_name}_windows",LOCKED:"binary_sensor.{car_name}_locked",ONLINE:"binary_sensor.{car_name}_online",SENTRY_MODE:"binary_sensor.{car_name}_sentry_mode",DOOR_DRIVER_FRONT:null,DOOR_DRIVER_REAR:null,DOOR_PASSENGER_FRONT:null,DOOR_PASSENGER_REAR:null,WINDOW_DRIVER_FRONT:null,WINDOW_DRIVER_REAR:null,WINDOW_PASSENGER_FRONT:null,WINDOW_PASSENGER_REAR:null,DOOR_LOCK:"lock.{car_name}_doors",CHARGER_SWITCH:"switch.{car_name}_charger",SENTRY_MODE_SWITCH:"switch.{car_name}_sentry_mode",DEFROST_SWITCH:"switch.{car_name}_defrost",CAMP_MODE:"switch.{car_name}_camp_mode",DOG_MODE:"switch.{car_name}_dog_mode",STEERING_WHEEL_HEATER:null,AUTO_STEERING_WHEEL_HEATER:null,CABIN_OVERHEAT:"select.{car_name}_cabin_overheat_protection",HEATED_SEAT_LEFT:"select.{car_name}_heated_seat_left",HEATED_SEAT_RIGHT:"select.{car_name}_heated_seat_right",HEATED_SEAT_REAR_LEFT:"select.{car_name}_heated_seat_rear_left",HEATED_SEAT_REAR_CENTER:"select.{car_name}_heated_seat_rear_center",HEATED_SEAT_REAR_RIGHT:"select.{car_name}_heated_seat_rear_right",CLIMATE:"climate.{car_name}_hvac_climate_system",CHARGE_LIMIT_NUMBER:"number.{car_name}_charge_limit",CHARGING_AMPS_NUMBER:"number.{car_name}_charging_amps",CHARGE_PORT_OPEN:"button.{car_name}_charge_port_open",CHARGE_PORT_CLOSE:"button.{car_name}_charge_port_close",HORN:"button.{car_name}_horn",FLASH_LIGHTS:"button.{car_name}_flash_lights",REMOTE_START:"button.{car_name}_remote_start",OPEN_FRUNK:"button.{car_name}_frunk",OPEN_TRUNK:"button.{car_name}_trunk",FORCE_UPDATE:"button.{car_name}_force_data_update",WINDOWS_COVER:"cover.{car_name}_windows",FRUNK_COVER:"cover.{car_name}_frunk",CHARGER_DOOR:"cover.{car_name}_charger_door",ENERGY_ADDED:"sensor.{car_name}_energy_added",TYRE_FL:null,TYRE_FR:null,TYRE_RL:null,TYRE_RR:null,TIME_TO_FULL_CHARGE:"sensor.{car_name}_time_to_full_charge",DISTANCE_TO_ARRIVAL:null,TIME_TO_ARRIVAL:null,LOCATION:"device_tracker.{car_name}_location_tracker",ROUTE:null},$s={fleet:dt,custom:Rs},qt=[{label:"Sensors",keys:[{key:"BATTERY_LEVEL",label:"Battery Level",domain:"sensor"},{key:"BATTERY_RANGE",label:"Battery Range",domain:"sensor"},{key:"CHARGING_STATE",label:"Charging State",domain:"sensor"},{key:"CHARGE_RATE",label:"Charge Rate",domain:"sensor"},{key:"TEMPERATURE_INSIDE",label:"Inside Temperature",domain:"sensor"},{key:"TEMPERATURE_OUTSIDE",label:"Outside Temperature",domain:"sensor"},{key:"ODOMETER",label:"Odometer",domain:"sensor"},{key:"ENERGY_ADDED",label:"Energy Added",domain:"sensor"}]},{label:"Status",keys:[{key:"ONLINE",label:"Online Status",domain:"binary_sensor"},{key:"PLUGGED_IN",label:"Plugged In",domain:"binary_sensor"},{key:"CHARGING",label:"Charge Switch",domain:"switch"},{key:"SENTRY_MODE",label:"Sentry Mode",domain:"switch"}]},{label:"Doors",keys:[{key:"DOOR_DRIVER_FRONT",label:"Driver Front",domain:"binary_sensor"},{key:"DOOR_DRIVER_REAR",label:"Driver Rear",domain:"binary_sensor"},{key:"DOOR_PASSENGER_FRONT",label:"Passenger Front",domain:"binary_sensor"},{key:"DOOR_PASSENGER_REAR",label:"Passenger Rear",domain:"binary_sensor"}]},{label:"Windows",keys:[{key:"WINDOW_DRIVER_FRONT",label:"Driver Front",domain:"binary_sensor"},{key:"WINDOW_DRIVER_REAR",label:"Driver Rear",domain:"binary_sensor"},{key:"WINDOW_PASSENGER_FRONT",label:"Passenger Front",domain:"binary_sensor"},{key:"WINDOW_PASSENGER_REAR",label:"Passenger Rear",domain:"binary_sensor"}]},{label:"Lock",keys:[{key:"DOOR_LOCK",label:"Door Lock",domain:"lock"}]},{label:"Climate",keys:[{key:"CLIMATE",label:"Climate",domain:"climate"},{key:"DEFROST_SWITCH",label:"Defrost",domain:"switch"},{key:"HEATED_SEAT_LEFT",label:"Heated Seat Front Left",domain:"select"},{key:"HEATED_SEAT_RIGHT",label:"Heated Seat Front Right",domain:"select"},{key:"HEATED_SEAT_REAR_LEFT",label:"Heated Seat Rear Left",domain:"select"},{key:"HEATED_SEAT_REAR_CENTER",label:"Heated Seat Rear Center",domain:"select"},{key:"HEATED_SEAT_REAR_RIGHT",label:"Heated Seat Rear Right",domain:"select"},{key:"STEERING_WHEEL_HEATER",label:"Steering Wheel Heater",domain:"select"},{key:"AUTO_STEERING_WHEEL_HEATER",label:"Auto Steering Wheel Heater",domain:"switch"},{key:"CABIN_OVERHEAT",label:"Cabin Overheat Protection",domain:"climate"},{key:"WINDOWS_COVER",label:"Windows (vent/close)",domain:"cover"}]},{label:"Charging",keys:[{key:"CHARGE_LIMIT_NUMBER",label:"Charge Limit",domain:"number"},{key:"CHARGING_AMPS_NUMBER",label:"Charging Amps",domain:"number"},{key:"CHARGER_DOOR",label:"Charge Port Door",domain:"cover"}]},{label:"Covers & Buttons",keys:[{key:"OPEN_FRUNK",label:"Frunk",domain:"cover"},{key:"OPEN_TRUNK",label:"Trunk",domain:"cover"},{key:"HORN",label:"Horn",domain:"button"},{key:"FLASH_LIGHTS",label:"Flash Lights",domain:"button"},{key:"REMOTE_START",label:"Remote Start",domain:"button"},{key:"FORCE_UPDATE",label:"Wake / Refresh",domain:"button"}]},{label:"Tyre Pressure",keys:[{key:"TYRE_FL",label:"Front Left",domain:"sensor"},{key:"TYRE_FR",label:"Front Right",domain:"sensor"},{key:"TYRE_RL",label:"Rear Left",domain:"sensor"},{key:"TYRE_RR",label:"Rear Right",domain:"sensor"}]},{label:"Navigation & Location",keys:[{key:"SPEED",label:"Speed",domain:"sensor"},{key:"DISTANCE_TO_ARRIVAL",label:"Distance to Arrival",domain:"sensor"},{key:"TIME_TO_ARRIVAL",label:"Time to Arrival",domain:"sensor"},{key:"LOCATION",label:"Location Tracker",domain:"device_tracker"},{key:"ROUTE",label:"Route Tracker",domain:"device_tracker"}]}],Be={CHARGER_SWITCH:"CHARGING",SENTRY_MODE_SWITCH:"SENTRY_MODE",FRUNK_COVER:"OPEN_FRUNK",CHARGE_LIMIT:"CHARGE_LIMIT_NUMBER",CHARGE_PORT_OPEN:"CHARGER_DOOR",CHARGE_PORT_CLOSE:"CHARGER_DOOR"},Cs=new Set(qt.flatMap(a=>a.keys.map(t=>t.key))),At={};for(let[a,t]of Object.entries(dt))t&&Cs.has(a)&&(At[t]=a);for(let[a,t]of Object.entries(dt))t&&!At[t]&&(At[t]=a);function Rt(a="fleet"){return a==="entities"?dt:$s[a]||dt}function W(a,t,e){if(!a)return null;if(e){let s=At[a];if(s&&!e[s]&&Be[s]&&(s=Be[s]),s&&e[s])return e[s]}return a.replace("{car_name}",(t??"").toLowerCase())}var Y={"cover.{car_name}_froot":"cover.{car_name}_frunk","cover.{car_name}_frunk":"cover.{car_name}_froot","cover.{car_name}_boot":"cover.{car_name}_trunk","cover.{car_name}_trunk":"cover.{car_name}_boot","cover.{car_name}_vent_windows":"cover.{car_name}_windows","cover.{car_name}_windows":"cover.{car_name}_vent_windows"};var l={lock:`<svg viewBox="24 13 54 67" fill="currentColor" stroke="none">
            ...
            ${qt.map(r=>{let p=this._overrideCount(r),h=r.keys.length;return o`
                <details class="entity-group">
                  ...
                  <div class="entity-group-body">
                    ${r.keys.map(_=>{let u=`el-${_.key}`,m=this._entitiesForDomain(_.domain);return o`
            ...
            ${S?o`
              ...
              <div class="clim-list-group clim-segment-group clim-list-group--last">
                ${["Off","No A/C","On"].map(B=>o`
                  <button class="clim-segment-btn${Tt===B?" selected":""}"
    ...
    `}};customElements.define("tesla-menu-controls",ie);var ae=class extends E{static get properties(){return{selected:{type:String},available:{type:Array},showBack:{type:Boolean},customH:{type:Number},customS:{type:Number},slideFrom:{type:String,reflect:!0,attribute:"slide-from"},_showCustom:{state:!0},_hue:{state:!0},_sat:{state:!0}}}static get styles(){return k`
      :host {
        display: block;
      ...
      <div class="picker-overlay" @click=${this._onOverlayClick}>
        <div class="picker-panel">
          ...
          <div class="picker-swatches">
            ${Ct.map(s=>{let i=t.includes(s.dir),n=this.selected===s.dir;return o`
                <button
    ...
    `}};customElements.define("tesla-colour-picker",ae);var ne=class extends E{static get properties(){return{model:{type:String},variant:{type:String},slideFrom:{type:String,reflect:!0,attribute:"slide-from"}}}static get styles(){return k`
      :host {
        display: block;
        font-family: system-ui, -apple-system, sans-serif;
      }
    ...
    `}};customElements.define("tesla-model-picker",ne);var Ts=["chargeport","frunk","fr","ff","nr","nf"],Ve={"nf+nr":"nf-nr-combined-overlay.png","ff+fr":"ff-fr-combined-overlay.png"},je="all-doors-overlay.png",Qe="oncharge-all-doors-overlay.png",Os=["fr"],Ms=["frunk","nf","nr"],We={"nf+nr":"oncharge-nf-nr-combined-overlay.png"},Ls="tesla-card-colour-",Ns="tesla-card-model-",Is="tesla-card-layout-",Ds="tesla-card-size-",Hs="tesla-card-tyre-unit-",Ye=["small","medium","large"],Ke=["psi","bar"],z=class z extends E{static get properties(){return{hass:{type:Object},config:{type:Object},_menu:{state:!0},_imageError:{state:!0},_settingsView:{state:!0},_modelOverride:{state:!0},_colourOverride:{state:!0},_layout:{state:!0},_settingsSlide:{state:!0},_cardSize:{state:!0},_tyreUnit:{state:!0}}}static get styles(){return[M,Fe]}get E(){return Rt(this.config?.integration)}constructor(){super(),this._menu=null,this._imageError=!1,this._settingsView=null,this._modelOverride=null,this._colourOverride=null,this._layout="portrait",this._settingsSlide=null,this._cardSize="medium",this._tyreUnit="psi",this._baseConfig=null,this._combinedAvail={},this._onchargeAvail=!1,this._cableAvail=!1,this._toggleCharger=()=>this._toggle("charger"),this._toggleClimate=()=>this._toggle("climate"),this._toggleControls=()=>this._toggle("controls"),this._handleCloseMenu=()=>{this._menu=null},this._handleColourChanged=t=>this._onColourChanged(t),this._handleModelChanged=t=>this._onModelChanged(t),this._handleModelBack=()=>{this._settingsSlide=null,this._settingsView="main"},this._handleColourBack=()=>{this._settingsSlide="left",this._settingsView="model"},this._handlePickerClose=()=>{this._settingsView=null,this._settingsSlide=null}}setConfig(t){if(!t.car_name&&t.integration!=="entities")throw new Error("car_name is required");this._baseConfig={car_model:"3",car_variant:"3.1",car_color:"red_multi_coat",image_path:"/hacsfiles/homeassistant-fe-tesla",show_speed:!0,...t},this._applyConfig()}_applyConfig(){let t={...this._baseConfig};this._modelOverride&&(t.car_model=this._modelOverride.model,t.car_variant=this._modelOverride.variant);let e=this._colourOverride;e&&(t.car_color=e.dir==="custom"?"neutral":e.dir),this.config=t,this._preloadCombinedOverlays()}_preloadCombinedOverlays(){for(let[n,r]of Object.entries(Ve)){let p=new Image;p.onload=()=>{this._combinedAvail[n]=!0,this.requestUpdate()},p.onerror=()=>{this._combinedAvail[n]=!1},p.src=this._overlayUrl(r)}let t=new Image;t.onload=()=>{this._onchargeAvail=!0,this.requestUpdate()},t.onerror=()=>{this._onchargeAvail=!1},t.src=this._overlayUrl("oncharge-base.png");let e=new Image;e.onload=()=>{this._cableAvail=!0,this.requestUpdate()},e.onerror=()=>{this._cableAvail=!1},e.src=this._overlayUrl("oncharge-cable-overlay.png");for(let[n,r]of Object.entries(We)){let p=new Image;p.onload=()=>{this._combinedAvail["oc_"+n]=!0,this.requestUpdate()},p.onerror=()=>{this._combinedAvail["oc_"+n]=!1},p.src=this._overlayUrl(r)}let s=new Image;s.onload=()=>{this._combinedAvail.all=!0,this.requestUpdate()},s.onerror=()=>{this._combinedAvail.all=!1},s.src=this._overlayUrl(je);let i=new Image;i.onload=()=>{this._combinedAvail.oc_all=!0,this.requestUpdate()},i.onerror=()=>{this._combinedAvail.oc_all=!1},i.src=this._overlayUrl(Qe)}static getConfigElement(){return document.createElement("tesla-card-editor")}static getStubConfig(){return{car_name:"",car_model:"3",car_variant:"3.1",car_color:"red_multi_coat",image_path:"/hacsfiles/homeassistant-fe-tesla"}}connectedCallback(){super.connectedCallback(),this._baseConfig&&(this._restoreModel(),this._restoreColour()),this._restoreLayout(),this._restoreSize(),this._restoreTyreUnit()}_colourLsKey(){return Ls+(this._baseConfig?.car_name??"default")}_restoreColour(){try{let t=localStorage.getItem(this._colourLsKey());if(!t)return;try{this._colourOverride=JSON.parse(t)}catch{this._colourOverride={dir:t}}this._applyConfig()}catch{}}_persistColour(){try{this._colourOverride?localStorage.setItem(this._colourLsKey(),JSON.stringify(this._colourOverride)):localStorage.removeItem(this._colourLsKey())}catch{}}_onColourChanged(t){let e=t.detail;e?e.dir==="custom"?this._colourOverride={dir:"custom",h:e.h,s:e.s}:this._colourOverride={dir:e.dir}:this._colourOverride=null,this._applyConfig(),this._persistColour(),this._imageError=!1}_modelLsKey(){return Ns+(this._baseConfig?.car_name??"default")}_restoreModel(){try{let t=localStorage.getItem(this._modelLsKey());t&&(this._modelOverride=JSON.parse(t),this._applyConfig())}catch{}}_persistModel(){try{this._modelOverride?localStorage.setItem(this._modelLsKey(),JSON.stringify(this._modelOverride)):localStorage.removeItem(this._modelLsKey())}catch{}}_onModelChanged(t){let{model:e,variant:s}=t.detail;this._modelOverride={model:e,variant:s};let i=this._colourOverride;i&&i.dir!=="custom"&&(Xt(e,s).includes(i.dir)||(this._colourOverride=null,this._persistColour())),this._applyConfig(),this._persistModel(),this._imageError=!1,this._settingsSlide="right",this._settingsView="colour"}_layoutLsKey(){return Is+(this._baseConfig?.car_name??"default")}_restoreLayout(){try{localStorage.getItem(this._layoutLsKey())==="landscape"&&(this._layout="landscape")}catch{}}_persistLayout(){try{localStorage.setItem(this._layoutLsKey(),this._layout)}catch{}}_toggleLayout(){this._layout=this._layout==="landscape"?"portrait":"landscape",this._persistLayout()}_sizeLsKey(){return Ds+(this._baseConfig?.car_name??"default")}_restoreSize(){try{let t=localStorage.getItem(this._sizeLsKey());t&&Ye.includes(t)&&(this._cardSize=t)}catch{}}_persistSize(){try{localStorage.setItem(this._sizeLsKey(),this._cardSize)}catch{}}_setCardSize(t){this._cardSize!==t&&(this._cardSize=t,this._persistSize())}_tyreUnitLsKey(){return Hs+(this._baseConfig?.car_name??"default")}_restoreTyreUnit(){try{let t=localStorage.getItem(this._tyreUnitLsKey());t&&Ke.includes(t)&&(this._tyreUnit=t)}catch{}}_persistTyreUnit(){try{localStorage.setItem(this._tyreUnitLsKey(),this._tyreUnit)}catch{}}_setTyreUnit(t){this._tyreUnit!==t&&(this._tyreUnit=t,this._persistTyreUnit())}_imgUrl(t){let{image_path:e,car_model:s,car_variant:i,car_color:n}=this.config;return`${e}/${s}/${i}/${n}/${t}?v=${z._imgVer}`}_overlayUrl(t){let{image_path:e,car_model:s,car_variant:i,car_color:n}=this.config;return`${e}/${s}/${i}/${n}/overlays/${t}?v=${z._imgVer}`}_btnUrl(t){return`${this.config.image_path}/buttons/${t}?v=${z._imgVer}`}get _customColour(){let t=this._colourOverride;return!t||t.dir!=="custom"?null:{h:t.h,s:t.s}}get _hasCustomOverlay(){let t=this._customColour;return!!t&&t.s>0}_maskUrl(t){let{image_path:e,car_model:s,car_variant:i}=this.config,n=t.replace(".png","-mask.png");return`${e}/${s}/${i}/neutral/${n}?v=${z._imgVer}`}_customOverlayStyleFor(t){let e=this._customColour;if(!e||e.s===0)return"";let s=this._maskUrl(t);return`position:absolute;inset:0;pointer-events:none;background:hsl(${e.h},${e.s}%,50%);mix-blend-mode:color;-webkit-mask-image:url(${s});mask-image:url(${s});-webkit-mask-size:contain;mask-size:contain;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center;`}_eid(t){let e=W(t,this.config.car_name,this.config.entity_overrides);if(e&&!this.hass?.states[e]&&Y[t]){let s=W(Y[t],this.config.car_name,this.config.entity_overrides);if(s&&this.hass?.states[s])return s}return e}_state(t){let e=this._eid(t);return e?this.hass?.states[e]:void 0}_val(t){return this._state(t)?.state}_attr(t,e){return this._state(t)?.attributes?.[e]}async _svc(t,e,s,i={}){if(s)try{await this.hass.callService(t,e,{entity_id:this._eid(s),...i})}catch(n){console.error("[tesla-card] service error",t,e,n)}}async _forceRefresh(){this._state(this.E.FORCE_UPDATE)&&await this._svc("button","press",this.E.FORCE_UPDATE);let e=[this.E.BATTERY_LEVEL,this.E.BATTERY_RANGE,this.E.CHARGING_STATE,this.E.CHARGE_RATE,this.E.CHARGING,this.E.PLUGGED_IN,this.E.ONLINE,this.E.CLIMATE,this.E.DOOR_LOCK,this.E.TEMPERATURE_INSIDE,this.E.TEMPERATURE_OUTSIDE,this.E.SENTRY_MODE,this.E.FRUNK_COVER,this.E.OPEN_TRUNK,this.E.CHARGER_DOOR,this.E.WINDOWS_COVER,this.E.CHARGE_LIMIT_NUMBER,this.E.CHARGING_AMPS_NUMBER,this.E.DOOR_DRIVER_FRONT,this.E.DOOR_DRIVER_REAR,this.E.DOOR_PASSENGER_FRONT,this.E.DOOR_PASSENGER_REAR,this.E.TIME_TO_FULL_CHARGE,this.E.SPEED,this.E.DISTANCE_TO_ARRIVAL,this.E.TIME_TO_ARRIVAL].map(s=>this._eid(s)).filter(s=>s&&this.hass?.states[s]);setTimeout(async()=>{try{await this.hass.callService("homeassistant","update_entity",{entity_id:e})}catch(s){console.error("[tesla-card] refresh error",s)}},5e3)}_toggle(t){this._menu=this._menu===t?null:t}_openSettings(){this._settingsView="main",this._settingsSlide=null}_openModelPicker(){this._settingsView="model",this._settingsSlide=null}_closeSettings(){this._settingsView=null,this._settingsSlide=null}_onSettingsOverlayClick(t){t.target===t.currentTarget&&this._closeSettings()}render(){if(!this.config||!this.hass)return o``;let t=this._menu,e=this._colourOverride,s=this._val(this.E.BATTERY_LEVEL),i=s!=null?Math.round(Number(s)):null,n=i!=null?Math.max(0,Math.min(100,i)):0,r=n>=50?"high":n>=20?"medium":"low",p=this._val(this.E.BATTERY_RANGE),h=this._attr(this.E.BATTERY_RANGE,"unit_of_measurement")??"km",_=p!=null?`${Math.round(Number(p))} ${h}`:null,u=this._val(this.E.CHARGING)==="on",m=u?"charging":r,g=this._val(this.E.ONLINE)==="on",b=this._state(this.E.ONLINE),x=this._val(this.E.TIME_TO_FULL_CHARGE),I=(()=>{if(!u||!x||x==="unavailable")return null;let d=new Date(x);if(isNaN(d))return null;let w=d-Date.now();if(w<=0)return"Complete";let V=Math.floor(w/36e5),be=Math.round(w%36e5/6e4);return V>=24?"24+ hours remaining to charge limit":V>0?`${V}h ${be}m remaining to charge limit`:`${be}m remaining to charge limit`})(),pt=this._val(this.E.FRUNK_COVER)==="open"||this._val(this.E.FRUNK)==="on",St=this._val(this.E.OPEN_TRUNK)==="open"||this._val(this.E.TRUNK)==="on",C=this._val(this.E.PLUGGED_IN)==="on",mt=this._val(this.E.CHARGER_DOOR)==="open"||C,y=this.E.DOOR_DRIVER_FRONT?{nf:this._val(this.E.DOOR_DRIVER_FRONT)==="on",nr:this._val(this.E.DOOR_DRIVER_REAR)==="on",ff:this._val(this.E.DOOR_PASSENGER_FRONT)==="on",fr:this._val(this.E.DOOR_PASSENGER_REAR)==="on"}:{nf:this._attr(this.E.DOORS,"driver_front")===!0,nr:this._attr(this.E.DOORS,"driver_rear")===!0,ff:this._attr(this.E.DOORS,"passenger_front")===!0,fr:this._attr(this.E.DOORS,"passenger_rear")===!0},v=C&&this._onchargeAvail,A=v?"oncharge-":"",q=`${A}base.png`,ut=v?Ms:Ts,_t=v?Os:[],D={frunk:pt,nf:y.nf,nr:y.nr,fr:y.fr};v||(D.chargeport=mt,D.ff=y.ff);let Z=v?"oc_all":"all",S=y.nf&&y.nr&&(v||y.ff)&&(v||y.fr)&&this._combinedAvail[Z],ft=v?"oc_nf+nr":"nf+nr",oe=!S&&y.nf&&y.nr&&this._combinedAvail[ft],Tt=!S&&!v&&y.ff&&y.fr&&this._combinedAvail["ff+fr"],X=v?We:Ve,F=[];for(let d of _t)S&&(d==="fr"||d==="ff"||d==="nf"||d==="nr")||D[d]&&F.push(`${A}${d}-overlay.png`);let Ot=St?`${A}trunk-overlay.png`:null,H=[],Mt=!1,J=!1,B=!1;for(let d of ut)if(D[d]){if(S&&(d==="nf"||d==="nr"||d==="ff"||d==="fr")){if(B)continue;B=!0;continue}if((d==="nf"||d==="nr")&&oe){Mt&&H.push(X["nf+nr"]),Mt=!0;continue}if((d==="ff"||d==="fr")&&Tt){J&&H.push(X["ff+fr"]),J=!0;continue}H.push(`${A}${d}-overlay.png`)}if(S){let d=v?Qe:je;H.push(d)}let Lt=this._val(this.E.DOOR_LOCK),bt=Lt==="locked",qe=this._val(this.E.CHARGING_STATE)??"\u2014",le=this._val(this.E.CHARGE_RATE),Ze=this._attr(this.E.CHARGE_RATE,"unit_of_measurement")??"kW",Nt=this._val(this.E.CLIMATE),It=Nt!=null&&Nt!=="off"&&Nt!=="unavailable",ce=this._attr(this.E.CLIMATE,"temperature"),Xe=this._attr(this.E.CLIMATE,"temperature_unit")??"\xB0C",Je=ce!=null?Number(ce).toFixed(1):"\u2014",he=this._val(this.E.SPEED)??this._attr(this.E.LOCATION,"speed"),de=he!=null?Number(he):0,ts=this._attr(this.E.SPEED,"unit_of_measurement")??"km/h",vt=g&&de>0,pe=!g&&b?"Asleep":u?"Charging":vt?`${Math.round(de)} ${ts}`:this.E.PARKING_BRAKE&&this._val(this.E.PARKING_BRAKE)==="on"||g?"Parked":null,Dt=this._val(this.E.DISTANCE_TO_ARRIVAL),Ht=this._val(this.E.TIME_TO_ARRIVAL),Us=this._attr(this.E.ROUTE,"destination"),me=vt&&Dt!=null&&Dt!=="unknown"&&Ht!=null&&Ht!=="unavailable"?(()=>{let d=`${Number(Dt).toFixed(1)} ${this._attr(this.E.DISTANCE_TO_ARRIVAL,"unit_of_measurement")??"km"} away`,w=new Date(Ht),V=isNaN(w)?"":w.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});return V?`${d} \xB7 ${V} arrival`:d})():null,tt=this._val(this.E.LOCATION),ue=tt&&tt!=="unknown"&&tt!=="unavailable",es=ue?tt.charAt(0).toUpperCase()+tt.slice(1).replace(/_/g," "):null,ss=le!=null?Number(le).toFixed(1):"\u2014",is=u?`Charging \xB7 ${ss} ${Ze}`:C?"Plugged in":qe,as=It?`${Je}${Xe}`:"Off",_e=Lt?bt?"Locked":"Unlocked":null,Ut=L.find(d=>d.id===this.config.car_model),ge=Ut?.variants.find(d=>d.id===this.config.car_variant),ns=Ut&&ge?`${Ut.name} \xB7 ${ge.label}`:this.config.car_model,fe=e?.dir==="custom",rs=fe?null:Ct.find(d=>d.dir===this.config.car_color),os=fe?"Custom":rs?.name??this.config.car_color,ls=Xt(this.config.car_model,this.config.car_variant),cs=this._layout==="landscape",hs=this._cardSize!=="medium"?`size-${this._cardSize}`:"";return o`
      <ha-card class="${cs?"landscape":""} ${hs}">
        ...
        ${t?"":o`
          <div class="header">
            <div class="header-left">
              ...
              ${I?o`<span class="status-text charging-status">${I}</span>`:pe?o`<span class="status-text">${pe}</span>`:""}
            </div>
          ...
          <div class="landing-body">
            <div class="landing-left">
              ...
              <div class="quick-actions">
                ...
                <button class="quick-btn ${It?"q-active q-climate-on":""}" @click=${this._toggleClimate}>
            ...
            <div class="nav-rows">
              <button class="nav-row"
                ...
                <div class="nav-text">
                  ...
                  ${_e?o`<span class="nav-sublabel">${_e}</span>`:""}
                </div>
                <span class="icon nav-chevron">${c(l["chevron-right"])}</span>
              </button>
              <button class="nav-row${It?" active":""}"
              ...
              <div class="nav-row nav-row-static">
                ...
                <div class="nav-text">
                  ...
                  <span class="nav-sublabel">${vt&&me?me:es}</span>
                </div>
                <span class="icon nav-chevron">${c(l["chevron-right"])}</span>
              </div>`:""}
              <button class="nav-row"
                ...
                <div class="nav-text">
                  ...
                  <span class="nav-sublabel">${is}</span>
                </div>
                <span class="icon nav-chevron">${c(l["chevron-right"])}</span>
              </button>
            </div>
              ...
              <div class="settings-rows">
                <button class="settings-row"
                  ...
                  <div class="settings-row-text">
                    ...
                    <span class="settings-row-sub">${ns} · ${os}</span>
                  </div>
