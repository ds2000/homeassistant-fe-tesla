var li=Object.defineProperty;var ci=(a,t,e)=>t in a?li(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var mt=(a,t,e)=>ci(a,typeof t!="symbol"?t+"":t,e);var ut=globalThis,gt=ut.ShadowRoot&&(ut.ShadyCSS===void 0||ut.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,It=Symbol(),_e=new WeakMap,Y=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==It)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(gt&&t===void 0){let i=e!==void 0&&e.length===1;i&&(t=_e.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&_e.set(e,t))}return t}toString(){return this.cssText}},fe=a=>new Y(typeof a=="string"?a:a+"",void 0,It),y=(a,...t)=>{let e=a.length===1?a[0]:t.reduce((i,s,n)=>i+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+a[n+1],a[0]);return new Y(e,a,It)},be=(a,t)=>{if(gt)a.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of t){let i=document.createElement("style"),s=ut.litNonce;s!==void 0&&i.setAttribute("nonce",s),i.textContent=e.cssText,a.appendChild(i)}},Lt=gt?a=>a:a=>a instanceof CSSStyleSheet?(t=>{let e="";for(let i of t.cssRules)e+=i.cssText;return fe(e)})(a):a;var{is:hi,defineProperty:di,getOwnPropertyDescriptor:pi,getOwnPropertyNames:mi,getOwnPropertySymbols:ui,getPrototypeOf:gi}=Object,O=globalThis,ve=O.trustedTypes,_i=ve?ve.emptyScript:"",fi=O.reactiveElementPolyfillSupport,q=(a,t)=>a,Dt={toAttribute(a,t){switch(t){case Boolean:a=a?_i:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,t){let e=a;switch(t){case Boolean:e=a!==null;break;case Number:e=a===null?null:Number(a);break;case Object:case Array:try{e=JSON.parse(a)}catch{e=null}}return e}},xe=(a,t)=>!hi(a,t),Ee={attribute:!0,type:String,converter:Dt,reflect:!1,useDefault:!1,hasChanged:xe};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),O.litPropertyMetadata??(O.litPropertyMetadata=new WeakMap);var A=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=Ee){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let i=Symbol(),s=this.getPropertyDescriptor(t,i,e);s!==void 0&&di(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){let{get:s,set:n}=pi(this.prototype,t)??{get(){return this[e]},set(r){this[e]=r}};return{get:s,set(r){let d=s?.call(this);n?.call(this,r),this.requestUpdate(t,d,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Ee}static _$Ei(){if(this.hasOwnProperty(q("elementProperties")))return;let t=gi(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(q("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(q("properties"))){let e=this.properties,i=[...mi(e),...ui(e)];for(let s of i)this.createProperty(s,e[s])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[i,s]of e)this.elementProperties.set(i,s)}this._$Eh=new Map;for(let[e,i]of this.elementProperties){let s=this._$Eu(e,i);s!==void 0&&this._$Eh.set(s,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let i=new Set(t.flat(1/0).reverse());for(let s of i)e.unshift(Lt(s))}else t!==void 0&&e.push(Lt(t));return e}static _$Eu(t,e){let i=e.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,e=this.constructor.elementProperties;for(let i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return be(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$ET(t,e){let i=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,i);if(s!==void 0&&i.reflect===!0){let n=(i.converter?.toAttribute!==void 0?i.converter:Dt).toAttribute(e,i.type);this._$Em=t,n==null?this.removeAttribute(s):this.setAttribute(s,n),this._$Em=null}}_$AK(t,e){let i=this.constructor,s=i._$Eh.get(t);if(s!==void 0&&this._$Em!==s){let n=i.getPropertyOptions(s),r=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:Dt;this._$Em=s;let d=r.fromAttribute(e,n.type);this[s]=d??this._$Ej?.get(s)??d,this._$Em=null}}requestUpdate(t,e,i,s=!1,n){if(t!==void 0){let r=this.constructor;if(s===!1&&(n=this[t]),i??(i=r.getPropertyOptions(t)),!((i.hasChanged??xe)(n,e)||i.useDefault&&i.reflect&&n===this._$Ej?.get(t)&&!this.hasAttribute(r._$Eu(t,i))))return;this.C(t,e,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:i,reflect:s,wrapped:n},r){i&&!(this._$Ej??(this._$Ej=new Map)).has(t)&&(this._$Ej.set(t,r??e??this[t]),n!==!0||r!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(e=void 0),this._$AL.set(t,e)),s===!0&&this._$Em!==t&&(this._$Eq??(this._$Eq=new Set)).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(let[s,n]of this._$Ep)this[s]=n;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[s,n]of i){let{wrapped:r}=n,d=this[s];r!==!0||this._$AL.has(s)||d===void 0||this.C(s,void 0,n,d)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(e)):this._$EM()}catch(i){throw t=!1,this._$EM(),i}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&(this._$Eq=this._$Eq.forEach(e=>this._$ET(e,this[e]))),this._$EM()}updated(t){}firstUpdated(t){}};A.elementStyles=[],A.shadowRootOptions={mode:"open"},A[q("elementProperties")]=new Map,A[q("finalized")]=new Map,fi?.({ReactiveElement:A}),(O.reactiveElementVersions??(O.reactiveElementVersions=[])).push("2.1.2");var X=globalThis,ye=a=>a,_t=X.trustedTypes,ke=_t?_t.createPolicy("lit-html",{createHTML:a=>a}):void 0,Se="$lit$",T=`lit$${Math.random().toFixed(9).slice(2)}$`,Oe="?"+T,bi=`<${Oe}>`,P=document,J=()=>P.createComment(""),tt=a=>a===null||typeof a!="object"&&typeof a!="function",Ft=Array.isArray,vi=a=>Ft(a)||typeof a?.[Symbol.iterator]=="function",Ht=`[ 	
\f\r]`,Z=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,we=/-->/g,Ae=/>/g,D=RegExp(`>|${Ht}(?:([^\\s"'>=/]+)(${Ht}*=${Ht}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Re=/'/g,$e=/"/g,Te=/^(?:script|style|textarea|title)$/i,Vt=a=>(t,...e)=>({_$litType$:a,strings:t,values:e}),o=Vt(1),Ui=Vt(2),Gi=Vt(3),R=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),Ce=new WeakMap,H=P.createTreeWalker(P,129);function Me(a,t){if(!Ft(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return ke!==void 0?ke.createHTML(t):t}var Ei=(a,t)=>{let e=a.length-1,i=[],s,n=t===2?"<svg>":t===3?"<math>":"",r=Z;for(let d=0;d<e;d++){let h=a[d],g,m,u=-1,_=0;for(;_<h.length&&(r.lastIndex=_,m=r.exec(h),m!==null);)_=r.lastIndex,r===Z?m[1]==="!--"?r=we:m[1]!==void 0?r=Ae:m[2]!==void 0?(Te.test(m[2])&&(s=RegExp("</"+m[2],"g")),r=D):m[3]!==void 0&&(r=D):r===D?m[0]===">"?(r=s??Z,u=-1):m[1]===void 0?u=-2:(u=r.lastIndex-m[2].length,g=m[1],r=m[3]===void 0?D:m[3]==='"'?$e:Re):r===$e||r===Re?r=D:r===we||r===Ae?r=Z:(r=D,s=void 0);let v=r===D&&a[d+1].startsWith("/>")?" ":"";n+=r===Z?h+bi:u>=0?(i.push(g),h.slice(0,u)+Se+h.slice(u)+T+v):h+T+(u===-2?d:v)}return[Me(a,n+(a[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]},et=class a{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let n=0,r=0,d=t.length-1,h=this.parts,[g,m]=Ei(t,e);if(this.el=a.createElement(g,i),H.currentNode=this.el.content,e===2||e===3){let u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(s=H.nextNode())!==null&&h.length<d;){if(s.nodeType===1){if(s.hasAttributes())for(let u of s.getAttributeNames())if(u.endsWith(Se)){let _=m[r++],v=s.getAttribute(u).split(T),k=/([.?@])?(.*)/.exec(_);h.push({type:1,index:n,name:k[2],strings:v,ctor:k[1]==="."?Ut:k[1]==="?"?Gt:k[1]==="@"?zt:F}),s.removeAttribute(u)}else u.startsWith(T)&&(h.push({type:6,index:n}),s.removeAttribute(u));if(Te.test(s.tagName)){let u=s.textContent.split(T),_=u.length-1;if(_>0){s.textContent=_t?_t.emptyScript:"";for(let v=0;v<_;v++)s.append(u[v],J()),H.nextNode(),h.push({type:2,index:++n});s.append(u[_],J())}}}else if(s.nodeType===8)if(s.data===Oe)h.push({type:2,index:n});else{let u=-1;for(;(u=s.data.indexOf(T,u+1))!==-1;)h.push({type:7,index:n}),u+=T.length-1}n++}}static createElement(t,e){let i=P.createElement("template");return i.innerHTML=t,i}};function B(a,t,e=a,i){if(t===R)return t;let s=i!==void 0?e._$Co?.[i]:e._$Cl,n=tt(t)?void 0:t._$litDirective$;return s?.constructor!==n&&(s?._$AO?.(!1),n===void 0?s=void 0:(s=new n(a),s._$AT(a,e,i)),i!==void 0?(e._$Co??(e._$Co=[]))[i]=s:e._$Cl=s),s!==void 0&&(t=B(a,s._$AS(a,t.values),s,i)),t}var Pt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??P).importNode(e,!0);H.currentNode=s;let n=H.nextNode(),r=0,d=0,h=i[0];for(;h!==void 0;){if(r===h.index){let g;h.type===2?g=new it(n,n.nextSibling,this,t):h.type===1?g=new h.ctor(n,h.name,h.strings,this,t):h.type===6&&(g=new Bt(n,this,t)),this._$AV.push(g),h=i[++d]}r!==h?.index&&(n=H.nextNode(),r++)}return H.currentNode=P,s}p(t){let e=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}},it=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=B(this,t,e),tt(t)?t===f||t==null||t===""?(this._$AH!==f&&this._$AR(),this._$AH=f):t!==this._$AH&&t!==R&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):vi(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==f&&tt(this._$AH)?this._$AA.nextSibling.data=t:this.T(P.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:i}=t,s=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=et.createElement(Me(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{let n=new Pt(s,this),r=n.u(this.options);n.p(e),this.T(r),this._$AH=n}}_$AC(t){let e=Ce.get(t.strings);return e===void 0&&Ce.set(t.strings,e=new et(t)),e}k(t){Ft(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,s=0;for(let n of t)s===e.length?e.push(i=new a(this.O(J()),this.O(J()),this,this.options)):i=e[s],i._$AI(n),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let i=ye(t).nextSibling;ye(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},F=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,n){this.type=1,this._$AH=f,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=f}_$AI(t,e=this,i,s){let n=this.strings,r=!1;if(n===void 0)t=B(this,t,e,0),r=!tt(t)||t!==this._$AH&&t!==R,r&&(this._$AH=t);else{let d=t,h,g;for(t=n[0],h=0;h<n.length-1;h++)g=B(this,d[i+h],e,h),g===R&&(g=this._$AH[h]),r||(r=!tt(g)||g!==this._$AH[h]),g===f?t=f:t!==f&&(t+=(g??"")+n[h+1]),this._$AH[h]=g}r&&!s&&this.j(t)}j(t){t===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Ut=class extends F{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===f?void 0:t}},Gt=class extends F{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==f)}},zt=class extends F{constructor(t,e,i,s,n){super(t,e,i,s,n),this.type=5}_$AI(t,e=this){if((t=B(this,t,e,0)??f)===R)return;let i=this._$AH,s=t===f&&i!==f||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==f&&(i===f||s);s&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Bt=class{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){B(this,t)}};var xi=X.litHtmlPolyfillSupport;xi?.(et,it),(X.litHtmlVersions??(X.litHtmlVersions=[])).push("3.3.2");var Ne=(a,t,e)=>{let i=e?.renderBefore??t,s=i._$litPart$;if(s===void 0){let n=e?.renderBefore??null;i._$litPart$=s=new it(t.insertBefore(J(),n),n,void 0,e??{})}return s._$AI(a),s};var st=globalThis,E=class extends A{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ne(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return R}};E._$litElement$=!0,E.finalized=!0,st.litElementHydrateSupport?.({LitElement:E});var yi=st.litElementPolyfillSupport;yi?.({LitElement:E});(st.litElementVersions??(st.litElementVersions=[])).push("4.2.2");var Ie={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Le=a=>(...t)=>({_$litDirective$:a,values:t}),ft=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var at=class extends ft{constructor(t){if(super(t),this.it=f,t.type!==Ie.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===f||t==null)return this._t=void 0,this.it=t;if(t===R)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;let e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};at.directiveName="unsafeHTML",at.resultType=1;var c=Le(at);var M=y`
  :host {
    display: block;
...
`;var nt={BATTERY_LEVEL:"sensor.{car_name}_battery_level",BATTERY_RANGE:"sensor.{car_name}_battery_range",CHARGE_RATE:"sensor.{car_name}_charge_rate",CHARGE_LIMIT:"number.{car_name}_charge_limit",CHARGING_STATE:"sensor.{car_name}_charging",TEMPERATURE_INSIDE:"sensor.{car_name}_inside_temperature",TEMPERATURE_OUTSIDE:"sensor.{car_name}_outside_temperature",SPEED:"sensor.{car_name}_speed",ODOMETER:"sensor.{car_name}_odometer",CHARGING:"switch.{car_name}_charge",PLUGGED_IN:"binary_sensor.{car_name}_charge_cable",PARKING_BRAKE:null,FRUNK:null,TRUNK:null,DOORS:null,WINDOWS:null,LOCKED:null,ONLINE:"binary_sensor.{car_name}_status",SENTRY_MODE:"switch.{car_name}_sentry_mode",DOOR_DRIVER_FRONT:"binary_sensor.{car_name}_front_driver_door",DOOR_DRIVER_REAR:"binary_sensor.{car_name}_rear_driver_door",DOOR_PASSENGER_FRONT:"binary_sensor.{car_name}_front_passenger_door",DOOR_PASSENGER_REAR:"binary_sensor.{car_name}_rear_passenger_door",WINDOW_DRIVER_FRONT:"binary_sensor.{car_name}_front_driver_window",WINDOW_DRIVER_REAR:"binary_sensor.{car_name}_rear_driver_window",WINDOW_PASSENGER_FRONT:"binary_sensor.{car_name}_front_passenger_window",WINDOW_PASSENGER_REAR:"binary_sensor.{car_name}_rear_passenger_window",DOOR_LOCK:"lock.{car_name}_lock",CHARGER_SWITCH:"switch.{car_name}_charge",SENTRY_MODE_SWITCH:"switch.{car_name}_sentry_mode",DEFROST_SWITCH:"switch.{car_name}_defrost",CAMP_MODE:null,DOG_MODE:null,CABIN_OVERHEAT:"climate.{car_name}_cabin_overheat_protection",HEATED_SEAT_LEFT:"select.{car_name}_seat_heater_front_left",HEATED_SEAT_RIGHT:"select.{car_name}_seat_heater_front_right",HEATED_SEAT_REAR_LEFT:"select.{car_name}_seat_heater_rear_left",HEATED_SEAT_REAR_CENTER:"select.{car_name}_seat_heater_rear_center",HEATED_SEAT_REAR_RIGHT:"select.{car_name}_seat_heater_rear_right",CLIMATE:"climate.{car_name}_climate",CHARGE_LIMIT_NUMBER:"number.{car_name}_charge_limit",CHARGING_AMPS_NUMBER:"number.{car_name}_charge_current",CHARGE_PORT_OPEN:"cover.{car_name}_charge_port_door",CHARGE_PORT_CLOSE:"cover.{car_name}_charge_port_door",HORN:"button.{car_name}_honk_horn",FLASH_LIGHTS:"button.{car_name}_flash_lights",REMOTE_START:"button.{car_name}_keyless_driving",OPEN_FRUNK:"cover.{car_name}_froot",OPEN_TRUNK:"cover.{car_name}_boot",FORCE_UPDATE:"button.{car_name}_wake",WINDOWS_COVER:"cover.{car_name}_vent_windows",FRUNK_COVER:"cover.{car_name}_froot",CHARGER_DOOR:"cover.{car_name}_charge_port_door",ENERGY_ADDED:"sensor.{car_name}_charge_energy_added",TIME_TO_FULL_CHARGE:"sensor.{car_name}_time_to_full_charge",DISTANCE_TO_ARRIVAL:"sensor.{car_name}_distance_to_arrival",TIME_TO_ARRIVAL:"sensor.{car_name}_time_to_arrival",LOCATION:"device_tracker.{car_name}_location",ROUTE:"device_tracker.{car_name}_route"},ki={BATTERY_LEVEL:"sensor.{car_name}_battery",BATTERY_RANGE:"sensor.{car_name}_battery_range",CHARGE_RATE:"sensor.{car_name}_charge_rate",CHARGE_LIMIT:"sensor.{car_name}_charge_limit",CHARGING_STATE:"sensor.{car_name}_charging_state",TEMPERATURE_INSIDE:"sensor.{car_name}_temperature_inside",TEMPERATURE_OUTSIDE:"sensor.{car_name}_temperature_outside",SPEED:"sensor.{car_name}_speed",ODOMETER:"sensor.{car_name}_odometer",CHARGING:"binary_sensor.{car_name}_charging",PLUGGED_IN:"binary_sensor.{car_name}_plugged_in",PARKING_BRAKE:"binary_sensor.{car_name}_parking_brake",FRUNK:"binary_sensor.{car_name}_frunk",TRUNK:"binary_sensor.{car_name}_trunk",DOORS:"binary_sensor.{car_name}_doors",WINDOWS:"binary_sensor.{car_name}_windows",LOCKED:"binary_sensor.{car_name}_locked",ONLINE:"binary_sensor.{car_name}_online",SENTRY_MODE:"binary_sensor.{car_name}_sentry_mode",DOOR_DRIVER_FRONT:null,DOOR_DRIVER_REAR:null,DOOR_PASSENGER_FRONT:null,DOOR_PASSENGER_REAR:null,WINDOW_DRIVER_FRONT:null,WINDOW_DRIVER_REAR:null,WINDOW_PASSENGER_FRONT:null,WINDOW_PASSENGER_REAR:null,DOOR_LOCK:"lock.{car_name}_doors",CHARGER_SWITCH:"switch.{car_name}_charger",SENTRY_MODE_SWITCH:"switch.{car_name}_sentry_mode",DEFROST_SWITCH:"switch.{car_name}_defrost",CAMP_MODE:"switch.{car_name}_camp_mode",DOG_MODE:"switch.{car_name}_dog_mode",CABIN_OVERHEAT:"select.{car_name}_cabin_overheat_protection",HEATED_SEAT_LEFT:"select.{car_name}_heated_seat_left",HEATED_SEAT_RIGHT:"select.{car_name}_heated_seat_right",HEATED_SEAT_REAR_LEFT:"select.{car_name}_heated_seat_rear_left",HEATED_SEAT_REAR_CENTER:"select.{car_name}_heated_seat_rear_center",HEATED_SEAT_REAR_RIGHT:"select.{car_name}_heated_seat_rear_right",CLIMATE:"climate.{car_name}_hvac_climate_system",CHARGE_LIMIT_NUMBER:"number.{car_name}_charge_limit",CHARGING_AMPS_NUMBER:"number.{car_name}_charging_amps",CHARGE_PORT_OPEN:"button.{car_name}_charge_port_open",CHARGE_PORT_CLOSE:"button.{car_name}_charge_port_close",HORN:"button.{car_name}_horn",FLASH_LIGHTS:"button.{car_name}_flash_lights",REMOTE_START:"button.{car_name}_remote_start",OPEN_FRUNK:"button.{car_name}_frunk",OPEN_TRUNK:"button.{car_name}_trunk",FORCE_UPDATE:"button.{car_name}_force_data_update",WINDOWS_COVER:"cover.{car_name}_windows",FRUNK_COVER:"cover.{car_name}_frunk",CHARGER_DOOR:"cover.{car_name}_charger_door",ENERGY_ADDED:"sensor.{car_name}_energy_added",TIME_TO_FULL_CHARGE:"sensor.{car_name}_time_to_full_charge",DISTANCE_TO_ARRIVAL:null,TIME_TO_ARRIVAL:null,LOCATION:"device_tracker.{car_name}_location_tracker",ROUTE:null},wi={fleet:nt,custom:ki},jt=[{label:"Sensors",keys:[{key:"BATTERY_LEVEL",label:"Battery Level",domain:"sensor"},{key:"BATTERY_RANGE",label:"Battery Range",domain:"sensor"},{key:"CHARGING_STATE",label:"Charging State",domain:"sensor"},{key:"CHARGE_RATE",label:"Charge Rate",domain:"sensor"},{key:"TEMPERATURE_INSIDE",label:"Inside Temperature",domain:"sensor"},{key:"TEMPERATURE_OUTSIDE",label:"Outside Temperature",domain:"sensor"},{key:"ODOMETER",label:"Odometer",domain:"sensor"},{key:"ENERGY_ADDED",label:"Energy Added",domain:"sensor"}]},{label:"Status",keys:[{key:"ONLINE",label:"Online Status",domain:"binary_sensor"},{key:"PLUGGED_IN",label:"Plugged In",domain:"binary_sensor"},{key:"CHARGING",label:"Charge Switch",domain:"switch"},{key:"SENTRY_MODE",label:"Sentry Mode",domain:"switch"}]},{label:"Doors",keys:[{key:"DOOR_DRIVER_FRONT",label:"Driver Front",domain:"binary_sensor"},{key:"DOOR_DRIVER_REAR",label:"Driver Rear",domain:"binary_sensor"},{key:"DOOR_PASSENGER_FRONT",label:"Passenger Front",domain:"binary_sensor"},{key:"DOOR_PASSENGER_REAR",label:"Passenger Rear",domain:"binary_sensor"}]},{label:"Windows",keys:[{key:"WINDOW_DRIVER_FRONT",label:"Driver Front",domain:"binary_sensor"},{key:"WINDOW_DRIVER_REAR",label:"Driver Rear",domain:"binary_sensor"},{key:"WINDOW_PASSENGER_FRONT",label:"Passenger Front",domain:"binary_sensor"},{key:"WINDOW_PASSENGER_REAR",label:"Passenger Rear",domain:"binary_sensor"}]},{label:"Lock",keys:[{key:"DOOR_LOCK",label:"Door Lock",domain:"lock"}]},{label:"Climate",keys:[{key:"CLIMATE",label:"Climate",domain:"climate"},{key:"DEFROST_SWITCH",label:"Defrost",domain:"switch"},{key:"HEATED_SEAT_LEFT",label:"Heated Seat Front Left",domain:"select"},{key:"HEATED_SEAT_RIGHT",label:"Heated Seat Front Right",domain:"select"},{key:"HEATED_SEAT_REAR_LEFT",label:"Heated Seat Rear Left",domain:"select"},{key:"HEATED_SEAT_REAR_CENTER",label:"Heated Seat Rear Center",domain:"select"},{key:"HEATED_SEAT_REAR_RIGHT",label:"Heated Seat Rear Right",domain:"select"},{key:"CABIN_OVERHEAT",label:"Cabin Overheat Protection",domain:"climate"},{key:"WINDOWS_COVER",label:"Windows (vent/close)",domain:"cover"}]},{label:"Charging",keys:[{key:"CHARGE_LIMIT_NUMBER",label:"Charge Limit",domain:"number"},{key:"CHARGING_AMPS_NUMBER",label:"Charging Amps",domain:"number"},{key:"CHARGER_DOOR",label:"Charge Port Door",domain:"cover"}]},{label:"Covers & Buttons",keys:[{key:"OPEN_FRUNK",label:"Frunk",domain:"cover"},{key:"OPEN_TRUNK",label:"Trunk",domain:"cover"},{key:"HORN",label:"Horn",domain:"button"},{key:"FLASH_LIGHTS",label:"Flash Lights",domain:"button"},{key:"REMOTE_START",label:"Remote Start",domain:"button"},{key:"FORCE_UPDATE",label:"Wake / Refresh",domain:"button"}]},{label:"Navigation & Location",keys:[{key:"SPEED",label:"Speed",domain:"sensor"},{key:"DISTANCE_TO_ARRIVAL",label:"Distance to Arrival",domain:"sensor"},{key:"TIME_TO_ARRIVAL",label:"Time to Arrival",domain:"sensor"},{key:"LOCATION",label:"Location Tracker",domain:"device_tracker"},{key:"ROUTE",label:"Route Tracker",domain:"device_tracker"}]}],Ge={CHARGER_SWITCH:"CHARGING",SENTRY_MODE_SWITCH:"SENTRY_MODE",FRUNK_COVER:"OPEN_FRUNK",CHARGE_LIMIT:"CHARGE_LIMIT_NUMBER",CHARGE_PORT_OPEN:"CHARGER_DOOR",CHARGE_PORT_CLOSE:"CHARGER_DOOR"},Ai=new Set(jt.flatMap(a=>a.keys.map(t=>t.key))),bt={};for(let[a,t]of Object.entries(nt))t&&Ai.has(a)&&(bt[t]=a);for(let[a,t]of Object.entries(nt))t&&!bt[t]&&(bt[t]=a);function vt(a="fleet"){return a==="entities"?nt:wi[a]||nt}function Et(a,t,e){if(!a)return null;if(e){let i=bt[a];if(i&&!e[i]&&Ge[i]&&(i=Ge[i]),i&&e[i])return e[i]}return a.replace("{car_name}",(t??"").toLowerCase())}var l={lock:`<svg viewBox="24 13 54 67" fill="currentColor" stroke="none">
      ...
      <div class="editor">
        ...
        ${s?o`
          ...
          <div class="entity-groups">
            ${jt.map(r=>{let d=this._overrideCount(r),h=r.keys.length;return o`
          ...
          <div class="clim-expanded-content">
            ...
            ${ct||L?o`
              <div class="clim-list-group">
                ${ct?o`
                  <button class="clim-list-item${ht?" hot":""}"
                    @click=${()=>this._togglePresetOrSwitch("camp",ht,this.E.CAMP_MODE)}>
                    <span class="icon clim-list-icon">${c(l.tent)}</span>
                    <span class="clim-list-label">Camp Mode</span>
                  </button>`:""}
                ${L?o`
                  <button class="clim-list-item${wt?" hot":""}"
                    @click=${()=>this._togglePresetOrSwitch("dog",wt,this.E.DOG_MODE)}>
            ...
            ${C?o`
              ...
              <div class="clim-list-group clim-segment-group clim-list-group--last">
                ${["Off","No A/C","On"].map(G=>o`
                  <button class="clim-segment-btn${At===G?" selected":""}"
    ...
    `}};customElements.define("tesla-menu-controls",Xt);var Jt=class extends E{static get properties(){return{selected:{type:String},available:{type:Array},showBack:{type:Boolean},customH:{type:Number},customS:{type:Number},slideFrom:{type:String,reflect:!0,attribute:"slide-from"},_showCustom:{state:!0},_hue:{state:!0},_sat:{state:!0}}}static get styles(){return y`
      :host {
        display: block;
      ...
      <div class="picker-overlay" @click=${this._onOverlayClick}>
        <div class="picker-panel">
          ...
          <div class="picker-swatches">
            ${yt.map(i=>{let s=t.includes(i.dir),n=this.selected===i.dir;return o`
                <button
    ...
    `}};customElements.define("tesla-colour-picker",Jt);var te=class extends E{static get properties(){return{model:{type:String},variant:{type:String},slideFrom:{type:String,reflect:!0,attribute:"slide-from"}}}static get styles(){return y`
      :host {
        display: block;
        font-family: system-ui, -apple-system, sans-serif;
      }
    ...
    `}};customElements.define("tesla-model-picker",te);var $i=["chargeport","frunk","fr","ff","nr","nf"],ze={"nf+nr":"nf-nr-combined-overlay.png","ff+fr":"ff-fr-combined-overlay.png"},Be="all-doors-overlay.png",Fe="oncharge-all-doors-overlay.png",Ci=["fr"],Si=["frunk","nf","nr"],Ve={"nf+nr":"oncharge-nf-nr-combined-overlay.png"},Oi="tesla-card-colour-",Ti="tesla-card-model-",Mi="tesla-card-layout-",Ni="tesla-card-size-",je=["small","medium","large"],U=class U extends E{static get properties(){return{hass:{type:Object},config:{type:Object},_menu:{state:!0},_imageError:{state:!0},_settingsView:{state:!0},_modelOverride:{state:!0},_colourOverride:{state:!0},_layout:{state:!0},_settingsSlide:{state:!0},_cardSize:{state:!0}}}static get styles(){return[M,Ue]}get E(){return vt(this.config?.integration)}constructor(){super(),this._menu=null,this._imageError=!1,this._settingsView=null,this._modelOverride=null,this._colourOverride=null,this._layout="portrait",this._settingsSlide=null,this._cardSize="medium",this._baseConfig=null,this._combinedAvail={},this._onchargeAvail=!1,this._cableAvail=!1,this._toggleCharger=()=>this._toggle("charger"),this._toggleClimate=()=>this._toggle("climate"),this._toggleControls=()=>this._toggle("controls"),this._handleCloseMenu=()=>{this._menu=null},this._handleColourChanged=t=>this._onColourChanged(t),this._handleModelChanged=t=>this._onModelChanged(t),this._handleModelBack=()=>{this._settingsSlide=null,this._settingsView="main"},this._handleColourBack=()=>{this._settingsSlide="left",this._settingsView="model"},this._handlePickerClose=()=>{this._settingsView=null,this._settingsSlide=null}}setConfig(t){if(!t.car_name&&t.integration!=="entities")throw new Error("car_name is required");this._baseConfig={car_model:"3",car_variant:"3.1",car_color:"red_multi_coat",image_path:"/hacsfiles/homeassistant-fe-tesla",show_speed:!0,...t},this._applyConfig()}_applyConfig(){let t={...this._baseConfig};this._modelOverride&&(t.car_model=this._modelOverride.model,t.car_variant=this._modelOverride.variant);let e=this._colourOverride;e&&(t.car_color=e.dir==="custom"?"neutral":e.dir),this.config=t,this._preloadCombinedOverlays()}_preloadCombinedOverlays(){for(let[n,r]of Object.entries(ze)){let d=new Image;d.onload=()=>{this._combinedAvail[n]=!0,this.requestUpdate()},d.onerror=()=>{this._combinedAvail[n]=!1},d.src=this._overlayUrl(r)}let t=new Image;t.onload=()=>{this._onchargeAvail=!0,this.requestUpdate()},t.onerror=()=>{this._onchargeAvail=!1},t.src=this._overlayUrl("oncharge-base.png");let e=new Image;e.onload=()=>{this._cableAvail=!0,this.requestUpdate()},e.onerror=()=>{this._cableAvail=!1},e.src=this._overlayUrl("oncharge-cable-overlay.png");for(let[n,r]of Object.entries(Ve)){let d=new Image;d.onload=()=>{this._combinedAvail["oc_"+n]=!0,this.requestUpdate()},d.onerror=()=>{this._combinedAvail["oc_"+n]=!1},d.src=this._overlayUrl(r)}let i=new Image;i.onload=()=>{this._combinedAvail.all=!0,this.requestUpdate()},i.onerror=()=>{this._combinedAvail.all=!1},i.src=this._overlayUrl(Be);let s=new Image;s.onload=()=>{this._combinedAvail.oc_all=!0,this.requestUpdate()},s.onerror=()=>{this._combinedAvail.oc_all=!1},s.src=this._overlayUrl(Fe)}static getConfigElement(){return document.createElement("tesla-card-editor")}static getStubConfig(){return{car_name:"",car_model:"3",car_variant:"3.1",car_color:"red_multi_coat",image_path:"/hacsfiles/homeassistant-fe-tesla"}}connectedCallback(){super.connectedCallback(),this._baseConfig&&(this._restoreModel(),this._restoreColour()),this._restoreLayout(),this._restoreSize()}_colourLsKey(){return Oi+(this._baseConfig?.car_name??"default")}_restoreColour(){try{let t=localStorage.getItem(this._colourLsKey());if(!t)return;try{this._colourOverride=JSON.parse(t)}catch{this._colourOverride={dir:t}}this._applyConfig()}catch{}}_persistColour(){try{this._colourOverride?localStorage.setItem(this._colourLsKey(),JSON.stringify(this._colourOverride)):localStorage.removeItem(this._colourLsKey())}catch{}}_onColourChanged(t){let e=t.detail;e?e.dir==="custom"?this._colourOverride={dir:"custom",h:e.h,s:e.s}:this._colourOverride={dir:e.dir}:this._colourOverride=null,this._applyConfig(),this._persistColour(),this._imageError=!1}_modelLsKey(){return Ti+(this._baseConfig?.car_name??"default")}_restoreModel(){try{let t=localStorage.getItem(this._modelLsKey());t&&(this._modelOverride=JSON.parse(t),this._applyConfig())}catch{}}_persistModel(){try{this._modelOverride?localStorage.setItem(this._modelLsKey(),JSON.stringify(this._modelOverride)):localStorage.removeItem(this._modelLsKey())}catch{}}_onModelChanged(t){let{model:e,variant:i}=t.detail;this._modelOverride={model:e,variant:i};let s=this._colourOverride;s&&s.dir!=="custom"&&(Wt(e,i).includes(s.dir)||(this._colourOverride=null,this._persistColour())),this._applyConfig(),this._persistModel(),this._imageError=!1,this._settingsSlide="right",this._settingsView="colour"}_layoutLsKey(){return Mi+(this._baseConfig?.car_name??"default")}_restoreLayout(){try{localStorage.getItem(this._layoutLsKey())==="landscape"&&(this._layout="landscape")}catch{}}_persistLayout(){try{localStorage.setItem(this._layoutLsKey(),this._layout)}catch{}}_toggleLayout(){this._layout=this._layout==="landscape"?"portrait":"landscape",this._persistLayout()}_sizeLsKey(){return Ni+(this._baseConfig?.car_name??"default")}_restoreSize(){try{let t=localStorage.getItem(this._sizeLsKey());t&&je.includes(t)&&(this._cardSize=t)}catch{}}_persistSize(){try{localStorage.setItem(this._sizeLsKey(),this._cardSize)}catch{}}_setCardSize(t){this._cardSize!==t&&(this._cardSize=t,this._persistSize())}_imgUrl(t){let{image_path:e,car_model:i,car_variant:s,car_color:n}=this.config;return`${e}/${i}/${s}/${n}/${t}?v=${U._imgVer}`}_overlayUrl(t){let{image_path:e,car_model:i,car_variant:s,car_color:n}=this.config;return`${e}/${i}/${s}/${n}/overlays/${t}?v=${U._imgVer}`}_btnUrl(t){return`${this.config.image_path}/buttons/${t}?v=${U._imgVer}`}get _customColour(){let t=this._colourOverride;return!t||t.dir!=="custom"?null:{h:t.h,s:t.s}}get _hasCustomOverlay(){let t=this._customColour;return!!t&&t.s>0}_maskUrl(t){let{image_path:e,car_model:i,car_variant:s}=this.config,n=t.replace(".png","-mask.png");return`${e}/${i}/${s}/neutral/${n}?v=${U._imgVer}`}_customOverlayStyleFor(t){let e=this._customColour;if(!e||e.s===0)return"";let i=this._maskUrl(t);return`position:absolute;inset:0;pointer-events:none;background:hsl(${e.h},${e.s}%,50%);mix-blend-mode:color;-webkit-mask-image:url(${i});mask-image:url(${i});-webkit-mask-size:contain;mask-size:contain;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center;`}_eid(t){return Et(t,this.config.car_name,this.config.entity_overrides)}_state(t){let e=this._eid(t);return e?this.hass?.states[e]:void 0}_val(t){return this._state(t)?.state}_attr(t,e){return this._state(t)?.attributes?.[e]}async _svc(t,e,i,s={}){if(i)try{await this.hass.callService(t,e,{entity_id:this._eid(i),...s})}catch(n){console.error("[tesla-card] service error",t,e,n)}}async _forceRefresh(){await this._svc("button","press",this.E.FORCE_UPDATE);let e=[this.E.BATTERY_LEVEL,this.E.BATTERY_RANGE,this.E.CHARGING_STATE,this.E.CHARGE_RATE,this.E.CHARGING,this.E.PLUGGED_IN,this.E.ONLINE,this.E.CLIMATE,this.E.DOOR_LOCK,this.E.TEMPERATURE_INSIDE,this.E.TEMPERATURE_OUTSIDE,this.E.SENTRY_MODE,this.E.FRUNK_COVER,this.E.OPEN_TRUNK,this.E.CHARGER_DOOR,this.E.WINDOWS_COVER,this.E.CHARGE_LIMIT_NUMBER,this.E.CHARGING_AMPS_NUMBER,this.E.DOOR_DRIVER_FRONT,this.E.DOOR_DRIVER_REAR,this.E.DOOR_PASSENGER_FRONT,this.E.DOOR_PASSENGER_REAR,this.E.TIME_TO_FULL_CHARGE,this.E.SPEED,this.E.DISTANCE_TO_ARRIVAL,this.E.TIME_TO_ARRIVAL].map(i=>this._eid(i)).filter(Boolean);setTimeout(async()=>{try{await this.hass.callService("homeassistant","update_entity",{entity_id:e})}catch(i){console.error("[tesla-card] refresh error",i)}},5e3)}_toggle(t){this._menu=this._menu===t?null:t}_openSettings(){this._settingsView="main",this._settingsSlide=null}_openModelPicker(){this._settingsView="model",this._settingsSlide=null}_closeSettings(){this._settingsView=null,this._settingsSlide=null}_onSettingsOverlayClick(t){t.target===t.currentTarget&&this._closeSettings()}render(){if(!this.config||!this.hass)return o``;let t=this._menu,e=this._colourOverride,i=this._val(this.E.BATTERY_LEVEL),s=i!=null?Math.round(Number(i)):null,n=s!=null?Math.max(0,Math.min(100,s)):0,r=n>=50?"high":n>=20?"medium":"low",d=this._val(this.E.BATTERY_RANGE),h=this._attr(this.E.BATTERY_RANGE,"unit_of_measurement")??"km",g=d!=null?`${Math.round(Number(d))} ${h}`:null,m=this._val(this.E.CHARGING)==="on",u=m?"charging":r,_=this._val(this.E.ONLINE)==="on",v=this._state(this.E.ONLINE),k=this._val(this.E.TIME_TO_FULL_CHARGE),j=(()=>{if(!m||!k||k==="unavailable")return null;let p=new Date(k);if(isNaN(p))return null;let S=p-Date.now();if(S<=0)return"Complete";let z=Math.floor(S/36e5),ge=Math.round(S%36e5/6e4);return z>=24?"24+ hours remaining to charge limit":z>0?`${z}h ${ge}m remaining to charge limit`:`${ge}m remaining to charge limit`})(),rt=this._val(this.E.FRUNK_COVER)==="open"||this._val(this.E.FRUNK)==="on",kt=this._val(this.E.OPEN_TRUNK)==="open"||this._val(this.E.TRUNK)==="on",$=this._val(this.E.PLUGGED_IN)==="on",ot=this._val(this.E.CHARGER_DOOR)==="open"||$,x=this.E.DOOR_DRIVER_FRONT?{nf:this._val(this.E.DOOR_DRIVER_FRONT)==="on",nr:this._val(this.E.DOOR_DRIVER_REAR)==="on",ff:this._val(this.E.DOOR_PASSENGER_FRONT)==="on",fr:this._val(this.E.DOOR_PASSENGER_REAR)==="on"}:{nf:this._attr(this.E.DOORS,"driver_front")===!0,nr:this._attr(this.E.DOORS,"driver_rear")===!0,ff:this._attr(this.E.DOORS,"passenger_front")===!0,fr:this._attr(this.E.DOORS,"passenger_rear")===!0},b=$&&this._onchargeAvail,w=b?"oncharge-":"",Q=`${w}base.png`,lt=b?Si:$i,ct=b?Ci:[],L={frunk:rt,nf:x.nf,nr:x.nr,fr:x.fr};b||(L.chargeport=ot,L.ff=x.ff);let ht=b?"oc_all":"all",C=x.nf&&x.nr&&(b||x.ff)&&(b||x.fr)&&this._combinedAvail[ht],dt=b?"oc_nf+nr":"nf+nr",ie=!C&&x.nf&&x.nr&&this._combinedAvail[dt],At=!C&&!b&&x.ff&&x.fr&&this._combinedAvail["ff+fr"],Rt=b?Ve:ze,W=[];for(let p of ct)C&&(p==="fr"||p==="ff"||p==="nf"||p==="nr")||L[p]&&W.push(`${w}${p}-overlay.png`);let G=kt?`${w}trunk-overlay.png`:null,K=[],se=!1,ae=!1,ne=!1;for(let p of lt)if(L[p]){if(C&&(p==="nf"||p==="nr"||p==="ff"||p==="fr")){if(ne)continue;ne=!0;continue}if((p==="nf"||p==="nr")&&ie){se&&K.push(Rt["nf+nr"]),se=!0;continue}if((p==="ff"||p==="fr")&&At){ae&&K.push(Rt["ff+fr"]),ae=!0;continue}K.push(`${w}${p}-overlay.png`)}if(C){let p=b?Fe:Be;K.push(p)}let $t=this._val(this.E.DOOR_LOCK),pt=$t==="locked",Qe=this._val(this.E.CHARGING_STATE)??"\u2014",re=this._val(this.E.CHARGE_RATE),We=this._attr(this.E.CHARGE_RATE,"unit_of_measurement")??"kW",Ct=this._val(this.E.CLIMATE),St=Ct!=null&&Ct!=="off"&&Ct!=="unavailable",oe=this._attr(this.E.CLIMATE,"temperature"),Ke=this._attr(this.E.CLIMATE,"temperature_unit")??"\xB0C",Ye=oe!=null?Number(oe).toFixed(1):"\u2014",le=this._val(this.E.SPEED)??this._attr(this.E.LOCATION,"speed"),ce=le!=null?Number(le):0,qe=this._attr(this.E.SPEED,"unit_of_measurement")??"km/h",Ot=_&&ce>0,he=!_&&v?"Asleep":m?"Charging":this.E.PARKING_BRAKE&&this._val(this.E.PARKING_BRAKE)==="on"?"Parked":Ot?`${Math.round(ce)} ${qe}`:_?"Parked":null,Tt=this._val(this.E.DISTANCE_TO_ARRIVAL),Mt=this._val(this.E.TIME_TO_ARRIVAL),Ze=this._attr(this.E.ROUTE,"destination"),de=Ot&&Tt!=null&&Tt!=="unknown"&&Mt!=null&&Mt!=="unavailable",Xe=de?(()=>{let p=`${Number(Tt).toFixed(1)} ${this._attr(this.E.DISTANCE_TO_ARRIVAL,"unit_of_measurement")??"km"} away`,S=new Date(Mt),z=isNaN(S)?"":S.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});return z?`${p} \xB7 ${z} arrival`:p})():null,Je=re!=null?Number(re).toFixed(1):"\u2014",ti=m?`Charging \xB7 ${Je} ${We}`:$?"Plugged in":Qe,ei=St?`${Ye}${Ke}`:"Off",pe=$t?pt?"Locked":"Unlocked":null,Nt=N.find(p=>p.id===this.config.car_model),me=Nt?.variants.find(p=>p.id===this.config.car_variant),ii=Nt&&me?`${Nt.name} \xB7 ${me.label}`:this.config.car_model,ue=e?.dir==="custom",si=ue?null:yt.find(p=>p.dir===this.config.car_color),ai=ue?"Custom":si?.name??this.config.car_color,ni=Wt(this.config.car_model,this.config.car_variant),ri=this._layout==="landscape",oi=this._cardSize!=="medium"?`size-${this._cardSize}`:"";return o`
      <ha-card class="${ri?"landscape":""} ${oi}">
        ...
        ${t?"":o`
          <div class="header">
            <div class="header-left">
              ...
              ${j?o`<span class="status-text charging-status">${j}</span>`:he?o`<span class="status-text">${he}</span>`:""}
            </div>
          ...
          <div class="landing-body">
            <div class="landing-left">
              ...
              <div class="quick-actions">
                ${$t?o`
                  <button class="quick-btn ${pt?"q-locked":"q-unlocked"}"
                    @click=${()=>this._svc("lock",pt?"unlock":"lock",this.E.DOOR_LOCK)}>
                    <span class="icon">${c(pt?l.lock:l.unlock)}</span>
                ...
                <button class="quick-btn ${St?"q-active q-climate-on":""}" @click=${this._toggleClimate}>
            ...
            <div class="nav-rows">
              <button class="nav-row"
                ...
                <div class="nav-text">
                  ...
                  ${pe?o`<span class="nav-sublabel">${pe}</span>`:""}
                </div>
                <span class="icon nav-chevron">${c(l["chevron-right"])}</span>
              </button>
              <button class="nav-row${St?" active":""}"
                @click=${this._toggleClimate}>
                <span class="icon nav-icon">${c(l["climate-fan"])}</span>
                <div class="nav-text">
                  <span class="nav-label">Climate</span>
                  <span class="nav-sublabel">${ei}</span>
                </div>
                <span class="icon nav-chevron">${c(l["chevron-right"])}</span>
              </button>
              ${de?o`
              <div class="nav-row nav-row-static">
                <span class="icon nav-icon">${c(l.navigation)}</span>
                <div class="nav-text">
                  <span class="nav-label">${Ze??"Navigation"}</span>
                  <span class="nav-sublabel">${Xe}</span>
                </div>
                <span class="icon nav-chevron">${c(l["chevron-right"])}</span>
              </div>`:""}
              <button class="nav-row"
                ...
                <div class="nav-text">
                  ...
                  <span class="nav-sublabel">${ti}</span>
                </div>
                <span class="icon nav-chevron">${c(l["chevron-right"])}</span>
              </button>
            </div>
              ...
              <div class="settings-rows">
                <button class="settings-row"
                  ...
                  <div class="settings-row-text">
                    ...
                    <span class="settings-row-sub">${ii} · ${ai}</span>
                  </div>
                  ...
                  <div class="settings-size-control">
                    ${je.map(p=>o`
                      <button class="settings-size-btn${this._cardSize===p?" selected":""}"
                        @click=${S=>{S.stopPropagation(),this._setCardSize(p)}}>
