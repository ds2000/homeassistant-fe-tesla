var Ue=Object.defineProperty;var ze=(n,t,e)=>t in n?Ue(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e;var nt=(n,t,e)=>ze(n,typeof t!="symbol"?t+"":t,e);var rt=globalThis,ot=rt.ShadowRoot&&(rt.ShadyCSS===void 0||rt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,bt=Symbol(),Wt=new WeakMap,F=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==bt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(ot&&t===void 0){let s=e!==void 0&&e.length===1;s&&(t=Wt.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&Wt.set(e,t))}return t}toString(){return this.cssText}},Yt=n=>new F(typeof n=="string"?n:n+"",void 0,bt),k=(n,...t)=>{let e=n.length===1?n[0]:t.reduce((s,i,a)=>s+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+n[a+1],n[0]);return new F(e,n,bt)},Zt=(n,t)=>{if(ot)n.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of t){let s=document.createElement("style"),i=rt.litNonce;i!==void 0&&s.setAttribute("nonce",i),s.textContent=e.cssText,n.appendChild(s)}},vt=ot?n=>n:n=>n instanceof CSSStyleSheet?(t=>{let e="";for(let s of t.cssRules)e+=s.cssText;return Yt(e)})(n):n;var{is:Pe,defineProperty:De,getOwnPropertyDescriptor:Be,getOwnPropertyNames:Qe,getOwnPropertySymbols:je,getPrototypeOf:Ge}=Object,S=globalThis,Xt=S.trustedTypes,Fe=Xt?Xt.emptyScript:"",Ve=S.reactiveElementPolyfillSupport,V=(n,t)=>n,xt={toAttribute(n,t){switch(t){case Boolean:n=n?Fe:null;break;case Object:case Array:n=n==null?n:JSON.stringify(n)}return n},fromAttribute(n,t){let e=n;switch(t){case Boolean:e=n!==null;break;case Number:e=n===null?null:Number(n);break;case Object:case Array:try{e=JSON.parse(n)}catch{e=null}}return e}},te=(n,t)=>!Pe(n,t),Jt={attribute:!0,type:String,converter:xt,reflect:!1,useDefault:!1,hasChanged:te};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),S.litPropertyMetadata??(S.litPropertyMetadata=new WeakMap);var A=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=Jt){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let s=Symbol(),i=this.getPropertyDescriptor(t,s,e);i!==void 0&&De(this.prototype,t,i)}}static getPropertyDescriptor(t,e,s){let{get:i,set:a}=Be(this.prototype,t)??{get(){return this[e]},set(o){this[e]=o}};return{get:i,set(o){let p=i?.call(this);a?.call(this,o),this.requestUpdate(t,p,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Jt}static _$Ei(){if(this.hasOwnProperty(V("elementProperties")))return;let t=Ge(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(V("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(V("properties"))){let e=this.properties,s=[...Qe(e),...je(e)];for(let i of s)this.createProperty(i,e[i])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[s,i]of e)this.elementProperties.set(s,i)}this._$Eh=new Map;for(let[e,s]of this.elementProperties){let i=this._$Eu(e,s);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let s=new Set(t.flat(1/0).reverse());for(let i of s)e.unshift(vt(i))}else t!==void 0&&e.push(vt(t));return e}static _$Eu(t,e){let s=e.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,e=this.constructor.elementProperties;for(let s of e.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Zt(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$ET(t,e){let s=this.constructor.elementProperties.get(t),i=this.constructor._$Eu(t,s);if(i!==void 0&&s.reflect===!0){let a=(s.converter?.toAttribute!==void 0?s.converter:xt).toAttribute(e,s.type);this._$Em=t,a==null?this.removeAttribute(i):this.setAttribute(i,a),this._$Em=null}}_$AK(t,e){let s=this.constructor,i=s._$Eh.get(t);if(i!==void 0&&this._$Em!==i){let a=s.getPropertyOptions(i),o=typeof a.converter=="function"?{fromAttribute:a.converter}:a.converter?.fromAttribute!==void 0?a.converter:xt;this._$Em=i;let p=o.fromAttribute(e,a.type);this[i]=p??this._$Ej?.get(i)??p,this._$Em=null}}requestUpdate(t,e,s,i=!1,a){if(t!==void 0){let o=this.constructor;if(i===!1&&(a=this[t]),s??(s=o.getPropertyOptions(t)),!((s.hasChanged??te)(a,e)||s.useDefault&&s.reflect&&a===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,s))))return;this.C(t,e,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:s,reflect:i,wrapped:a},o){s&&!(this._$Ej??(this._$Ej=new Map)).has(t)&&(this._$Ej.set(t,o??e??this[t]),a!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||s||(e=void 0),this._$AL.set(t,e)),i===!0&&this._$Em!==t&&(this._$Eq??(this._$Eq=new Set)).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(let[i,a]of this._$Ep)this[i]=a;this._$Ep=void 0}let s=this.constructor.elementProperties;if(s.size>0)for(let[i,a]of s){let{wrapped:o}=a,p=this[i];o!==!0||this._$AL.has(i)||p===void 0||this.C(i,void 0,a,p)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(e)):this._$EM()}catch(s){throw t=!1,this._$EM(),s}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&(this._$Eq=this._$Eq.forEach(e=>this._$ET(e,this[e]))),this._$EM()}updated(t){}firstUpdated(t){}};A.elementStyles=[],A.shadowRootOptions={mode:"open"},A[V("elementProperties")]=new Map,A[V("finalized")]=new Map,Ve?.({ReactiveElement:A}),(S.reactiveElementVersions??(S.reactiveElementVersions=[])).push("2.1.2");var q=globalThis,ee=n=>n,lt=q.trustedTypes,se=lt?lt.createPolicy("lit-html",{createHTML:n=>n}):void 0,le="$lit$",M=`lit$${Math.random().toFixed(9).slice(2)}$`,ce="?"+M,Ke=`<${ce}>`,H=document,W=()=>H.createComment(""),Y=n=>n===null||typeof n!="object"&&typeof n!="function",Et=Array.isArray,qe=n=>Et(n)||typeof n?.[Symbol.iterator]=="function",kt=`[ 	
\f\r]`,K=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ie=/-->/g,ae=/>/g,I=RegExp(`>|${kt}(?:([^\\s"'>=/]+)(${kt}*=${kt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ne=/'/g,re=/"/g,de=/^(?:script|style|textarea|title)$/i,St=n=>(t,...e)=>({_$litType$:n,strings:t,values:e}),c=St(1),ds=St(2),hs=St(3),C=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),oe=new WeakMap,N=H.createTreeWalker(H,129);function he(n,t){if(!Et(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return se!==void 0?se.createHTML(t):t}var We=(n,t)=>{let e=n.length-1,s=[],i,a=t===2?"<svg>":t===3?"<math>":"",o=K;for(let p=0;p<e;p++){let h=n[p],g,m,u=-1,b=0;for(;b<h.length&&(o.lastIndex=b,m=o.exec(h),m!==null);)b=o.lastIndex,o===K?m[1]==="!--"?o=ie:m[1]!==void 0?o=ae:m[2]!==void 0?(de.test(m[2])&&(i=RegExp("</"+m[2],"g")),o=I):m[3]!==void 0&&(o=I):o===I?m[0]===">"?(o=i??K,u=-1):m[1]===void 0?u=-2:(u=o.lastIndex-m[2].length,g=m[1],o=m[3]===void 0?I:m[3]==='"'?re:ne):o===re||o===ne?o=I:o===ie||o===ae?o=K:(o=I,i=void 0);let v=o===I&&n[p+1].startsWith("/>")?" ":"";a+=o===K?h+Ke:u>=0?(s.push(g),h.slice(0,u)+le+h.slice(u)+M+v):h+M+(u===-2?p:v)}return[he(n,a+(n[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]},Z=class n{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let a=0,o=0,p=t.length-1,h=this.parts,[g,m]=We(t,e);if(this.el=n.createElement(g,s),N.currentNode=this.el.content,e===2||e===3){let u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(i=N.nextNode())!==null&&h.length<p;){if(i.nodeType===1){if(i.hasAttributes())for(let u of i.getAttributeNames())if(u.endsWith(le)){let b=m[o++],v=i.getAttribute(u).split(M),y=/([.?@])?(.*)/.exec(b);h.push({type:1,index:a,name:y[2],strings:v,ctor:y[1]==="."?yt:y[1]==="?"?$t:y[1]==="@"?At:Q}),i.removeAttribute(u)}else u.startsWith(M)&&(h.push({type:6,index:a}),i.removeAttribute(u));if(de.test(i.tagName)){let u=i.textContent.split(M),b=u.length-1;if(b>0){i.textContent=lt?lt.emptyScript:"";for(let v=0;v<b;v++)i.append(u[v],W()),N.nextNode(),h.push({type:2,index:++a});i.append(u[b],W())}}}else if(i.nodeType===8)if(i.data===ce)h.push({type:2,index:a});else{let u=-1;for(;(u=i.data.indexOf(M,u+1))!==-1;)h.push({type:7,index:a}),u+=M.length-1}a++}}static createElement(t,e){let s=H.createElement("template");return s.innerHTML=t,s}};function B(n,t,e=n,s){if(t===C)return t;let i=s!==void 0?e._$Co?.[s]:e._$Cl,a=Y(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(n),i._$AT(n,e,s)),s!==void 0?(e._$Co??(e._$Co=[]))[s]=i:e._$Cl=i),i!==void 0&&(t=B(n,i._$AS(n,t.values),i,s)),t}var wt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??H).importNode(e,!0);N.currentNode=i;let a=N.nextNode(),o=0,p=0,h=s[0];for(;h!==void 0;){if(o===h.index){let g;h.type===2?g=new X(a,a.nextSibling,this,t):h.type===1?g=new h.ctor(a,h.name,h.strings,this,t):h.type===6&&(g=new Ct(a,this,t)),this._$AV.push(g),h=s[++p]}o!==h?.index&&(a=N.nextNode(),o++)}return N.currentNode=H,i}p(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},X=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=B(this,t,e),Y(t)?t===_||t==null||t===""?(this._$AH!==_&&this._$AR(),this._$AH=_):t!==this._$AH&&t!==C&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):qe(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==_&&Y(this._$AH)?this._$AA.nextSibling.data=t:this.T(H.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:s}=t,i=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=Z.createElement(he(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{let a=new wt(i,this),o=a.u(this.options);a.p(e),this.T(o),this._$AH=a}}_$AC(t){let e=oe.get(t.strings);return e===void 0&&oe.set(t.strings,e=new Z(t)),e}k(t){Et(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,i=0;for(let a of t)i===e.length?e.push(s=new n(this.O(W()),this.O(W()),this,this.options)):s=e[i],s._$AI(a),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let s=ee(t).nextSibling;ee(t).remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},Q=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,a){this.type=1,this._$AH=_,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=a,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=_}_$AI(t,e=this,s,i){let a=this.strings,o=!1;if(a===void 0)t=B(this,t,e,0),o=!Y(t)||t!==this._$AH&&t!==C,o&&(this._$AH=t);else{let p=t,h,g;for(t=a[0],h=0;h<a.length-1;h++)g=B(this,p[s+h],e,h),g===C&&(g=this._$AH[h]),o||(o=!Y(g)||g!==this._$AH[h]),g===_?t=_:t!==_&&(t+=(g??"")+a[h+1]),this._$AH[h]=g}o&&!i&&this.j(t)}j(t){t===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},yt=class extends Q{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===_?void 0:t}},$t=class extends Q{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==_)}},At=class extends Q{constructor(t,e,s,i,a){super(t,e,s,i,a),this.type=5}_$AI(t,e=this){if((t=B(this,t,e,0)??_)===C)return;let s=this._$AH,i=t===_&&s!==_||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,a=t!==_&&(s===_||i);i&&this.element.removeEventListener(this.name,this,s),a&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Ct=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){B(this,t)}};var Ye=q.litHtmlPolyfillSupport;Ye?.(Z,X),(q.litHtmlVersions??(q.litHtmlVersions=[])).push("3.3.2");var pe=(n,t,e)=>{let s=e?.renderBefore??t,i=s._$litPart$;if(i===void 0){let a=e?.renderBefore??null;s._$litPart$=i=new X(t.insertBefore(W(),a),a,void 0,e??{})}return i._$AI(n),i};var J=globalThis,x=class extends A{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=pe(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return C}};x._$litElement$=!0,x.finalized=!0,J.litElementHydrateSupport?.({LitElement:x});var Ze=J.litElementPolyfillSupport;Ze?.({LitElement:x});(J.litElementVersions??(J.litElementVersions=[])).push("4.2.2");var ue={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},me=n=>(...t)=>({_$litDirective$:n,values:t}),ct=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var tt=class extends ct{constructor(t){if(super(t),this.it=_,t.type!==ue.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===_||t==null)return this._t=void 0,this.it=t;if(t===C)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;let e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};tt.directiveName="unsafeHTML",tt.resultType=1;var d=me(tt);var O=k`
  :host {
    display: block;
...
`;var r={BATTERY_LEVEL:"sensor.{car_name}_battery",BATTERY_RANGE:"sensor.{car_name}_battery_range",CHARGE_RATE:"sensor.{car_name}_charge_rate",CHARGE_LIMIT:"sensor.{car_name}_charge_limit",CHARGING_STATE:"sensor.{car_name}_charging_state",TEMPERATURE_INSIDE:"sensor.{car_name}_temperature_inside",TEMPERATURE_OUTSIDE:"sensor.{car_name}_temperature_outside",SPEED:"sensor.{car_name}_speed",ODOMETER:"sensor.{car_name}_odometer",CHARGING:"binary_sensor.{car_name}_charging",PLUGGED_IN:"binary_sensor.{car_name}_plugged_in",PARKING_BRAKE:"binary_sensor.{car_name}_parking_brake",FRUNK:"binary_sensor.{car_name}_frunk",TRUNK:"binary_sensor.{car_name}_trunk",DOORS:"binary_sensor.{car_name}_doors",WINDOWS:"binary_sensor.{car_name}_windows",LOCKED:"binary_sensor.{car_name}_locked",ONLINE:"binary_sensor.{car_name}_online",SENTRY_MODE:"binary_sensor.{car_name}_sentry_mode",DOOR_LOCK:"lock.{car_name}_doors",CHARGER_SWITCH:"switch.{car_name}_charger",SENTRY_MODE_SWITCH:"switch.{car_name}_sentry_mode",DEFROST_SWITCH:"switch.{car_name}_defrost",CAMP_MODE:"switch.{car_name}_camp_mode",DOG_MODE:"switch.{car_name}_dog_mode",CABIN_OVERHEAT:"select.{car_name}_cabin_overheat_protection",HEATED_SEAT_LEFT:"select.{car_name}_heated_seat_left",HEATED_SEAT_RIGHT:"select.{car_name}_heated_seat_right",HEATED_SEAT_REAR_LEFT:"select.{car_name}_heated_seat_rear_left",HEATED_SEAT_REAR_CENTER:"select.{car_name}_heated_seat_rear_center",HEATED_SEAT_REAR_RIGHT:"select.{car_name}_heated_seat_rear_right",CLIMATE:"climate.{car_name}_hvac_climate_system",CHARGE_LIMIT_NUMBER:"number.{car_name}_charge_limit",CHARGING_AMPS_NUMBER:"number.{car_name}_charging_amps",CHARGE_PORT_OPEN:"button.{car_name}_charge_port_open",CHARGE_PORT_CLOSE:"button.{car_name}_charge_port_close",VENT_WINDOWS:"button.{car_name}_vent_windows",CLOSE_WINDOWS:"button.{car_name}_close_windows",HORN:"button.{car_name}_horn",FLASH_LIGHTS:"button.{car_name}_flash_lights",REMOTE_START:"button.{car_name}_remote_start",OPEN_FRUNK:"button.{car_name}_frunk",OPEN_TRUNK:"button.{car_name}_trunk",FORCE_UPDATE:"button.{car_name}_force_data_update",WINDOWS_COVER:"cover.{car_name}_windows",FRUNK_COVER:"cover.{car_name}_frunk",CHARGER_DOOR:"cover.{car_name}_charger_door",ENERGY_ADDED:"sensor.{car_name}_energy_added",LOCATION:"device_tracker.{car_name}_location_tracker"};function dt(n,t){return n.replace("{car_name}",t)}var l={lock:`<svg viewBox="24 13 54 67" fill="currentColor" stroke="none">
    ...
    `}};customElements.define("tesla-card-editor",Tt);var j=class j extends x{static get properties(){return{hass:{type:Object},config:{type:Object},customColour:{type:Object},layout:{type:String}}}_eid(t){return dt(t,this.config.car_name)}_state(t){return this.hass?.states[this._eid(t)]}_val(t){return this._state(t)?.state}_attr(t,e){return this._state(t)?.attributes?.[e]}_nattr(t,e){let s=this._attr(t,e);return s!=null?Number(s):null}_imgUrl(t){let{image_path:e,car_model:s,car_variant:i,car_color:a}=this.config;return`${e}/${s}/${i}/${a}/${t}?v=${j._imgVer}`}_btnUrl(t){return`${this.config.image_path}/buttons/${t}?v=${j._imgVer}`}_maskUrl(t){let{image_path:e,car_model:s,car_variant:i}=this.config,a=t.replace(".png","-mask.png");return`${e}/${s}/${i}/neutral/${a}?v=${j._imgVer}`}get _hasCustomOverlay(){return!!this.customColour&&this.customColour.s>0}_customOverlayStyleFor(t){let e=this.customColour;if(!e||e.s===0)return"";let s=this._maskUrl(t);return`position:absolute;inset:0;pointer-events:none;background:hsl(${e.h},${e.s}%,50%);mix-blend-mode:color;-webkit-mask-image:url(${s});mask-image:url(${s});-webkit-mask-size:contain;mask-size:contain;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center;`}async _svc(t,e,s,i={}){try{await this.hass.callService(t,e,{entity_id:this._eid(s),...i})}catch(a){console.error("[tesla-card] service error",t,e,a)}}_close(){this.dispatchEvent(new CustomEvent("close-menu",{bubbles:!0,composed:!0}))}};nt(j,"_imgVer",Date.now());var T=j;var Lt=class extends T{static get properties(){return{...super.properties,_pendingLimit:{state:!0},_pendingAmps:{state:!0}}}static get styles(){return[O,ge]}constructor(){super(),this._pendingLimit=null,this._pendingAmps=null}_pct(t,e,s){return Math.round((t-e)/(s-e)*100)}_onLimitInput(t){t.target.style.setProperty("--pct",`${this._pct(+t.target.value,+t.target.min,+t.target.max)}%`),this._pendingLimit=+t.target.value}_onLimitChange(t){this._pendingLimit=null,this._svc("number","set_value",r.CHARGE_LIMIT_NUMBER,{value:+t.target.value})}_onAmpsInput(t){t.target.style.setProperty("--pct",`${this._pct(+t.target.value,+t.target.min,+t.target.max)}%`),this._pendingAmps=+t.target.value}_onAmpsChange(t){this._pendingAmps=null,this._svc("number","set_value",r.CHARGING_AMPS_NUMBER,{value:+t.target.value})}_adjustAmps(t){let e=this._nattr(r.CHARGING_AMPS_NUMBER,"step")??1,s=this._nattr(r.CHARGING_AMPS_NUMBER,"min")??5,i=this._nattr(r.CHARGING_AMPS_NUMBER,"max")??32,a=this._pendingAmps??Number(this._val(r.CHARGING_AMPS_NUMBER)??16);this._pendingAmps=Math.max(s,Math.min(i,a+t*e)),clearTimeout(this._ampsTimer),this._ampsTimer=setTimeout(()=>{this._svc("number","set_value",r.CHARGING_AMPS_NUMBER,{value:this._pendingAmps}),this._pendingAmps=null},800)}render(){if(!this.config||!this.hass)return c``;let t=this._val(r.BATTERY_RANGE),e=this._attr(r.BATTERY_RANGE,"unit_of_measurement")??"km",s=t!=null?`${Math.round(Number(t))} ${e}`:null,i=this._val(r.CHARGER_DOOR)==="open"||this._val(r.PLUGGED_IN)==="on",a=this._pendingLimit??Number(this._val(r.CHARGE_LIMIT_NUMBER)??80),o=this._nattr(r.CHARGE_LIMIT_NUMBER,"min")??50,p=this._nattr(r.CHARGE_LIMIT_NUMBER,"max")??100,h=this._nattr(r.CHARGE_LIMIT_NUMBER,"step")??1,g=this._pct(a,o,p),m=this._pendingAmps??Number(this._val(r.CHARGING_AMPS_NUMBER)??16),u=this._nattr(r.CHARGING_AMPS_NUMBER,"min")??5,b=this._nattr(r.CHARGING_AMPS_NUMBER,"max")??32,v=this._attr(r.ENERGY_ADDED,"added_range");return c`
      <div class="charger-menu${this.layout==="landscape"?" landscape":""}">
        ...
        <div class="panel-header">
          <button class="panel-back" @click=${this._close}>
            <span class="icon">${d(l["chevron-left"])}</span>
          </button>
        ...
        <div class="chg-card">
          ...
          <div class="chg-amps-row">
            ...
            <button class="chg-amps-btn"
              ?disabled=${m>=b}
              @click=${()=>this._adjustAmps(1)}>
              <span class="icon">${d(l["chevron-right"])}</span>
            </button>
          </div>
        </div>
        ...
        <div class="clim-car-area${this._climExpanded?" clim-car-collapsed":""}">
          <div class="clim-car-inner">
            ...
            ${this._hasCustomOverlay?c`
              <div style="${this._customOverlayStyleFor(st)}"></div>`:""}
        ...
        <div class="clim-sheet${this._climExpanded?" expanded":""}">
          ...
          <div class="clim-main-row">
            <button class="clim-icon-btn${e?" clim-active":""}"
              ...
              <span class="icon">${d(l.power)}</span>
              <span>${e?"On":"Off"}</span>
            </button>
            ...
            <button class="clim-icon-btn${L?" clim-active":""}"
              ...
              <span class="icon">${d(L?l["vent-close"]:l["vent-open"])}</span>
          ...
          <button class="clim-full-btn${h?" active":""}"
            ...
            <span class="icon">${d(l.defrost)}</span>
          ...
          <div class="clim-expanded-content">
            ...
            <div class="clim-list-group">
              <button class="clim-list-item${et?" hot":""}"
                ...
                <span class="icon clim-list-icon">${d(l.tent)}</span>
                <span class="clim-list-label">Camp Mode</span>
              </button>
              <button class="clim-list-item${P?" hot":""}"
                @click=${()=>this._svc("switch",P?"turn_off":"turn_on",r.DOG_MODE)}>
                <span class="icon clim-list-icon">${d(l.dog)}</span>
            ...
            <div class="clim-list-group clim-segment-group clim-list-group--last">
              ${["Off","No A/C","On"].map(D=>c`
                <button class="clim-segment-btn${ut===D?" selected":""}"
                  @click=${()=>this._svc("select","select_option",r.CABIN_OVERHEAT,{option:D})}>
                  ${D}
                </button>`)}
            </div>
    ...
    `}};customElements.define("tesla-menu-climate",It);var Nt=class extends T{static get styles(){return[O,_e]}render(){if(!this.config||!this.hass)return c``;let e=this._val(r.DOOR_LOCK)==="locked",s=this._val(r.FRUNK_COVER)==="open"||this._val(r.FRUNK)==="on",i=this._val(r.TRUNK)==="on",a=this._val(r.PLUGGED_IN)==="on",o=this._val(r.CHARGER_DOOR)==="open"||a,p=this._val(r.WINDOWS_COVER)==="open",h=a?"controls-bg-charging.png":"controls-bg.png";return c`
      <div class="controls-menu${this.layout==="landscape"?" landscape":""}">
        ...
        <div class="ctrl-car-area">
          ...
          <button class="ctrl-zone ctrl-lock"
            ...
            <span class="icon">${d(e?l.lock:l.unlock)}</span>
          </button>
          ...
          <button class="ctrl-zone ctrl-port ${o?"port-open":""}"
            ...
            <span class="icon">${d(l["charge-bolt"])}</span>
          </button>
        </div>
        <div class="ctrl-actions">
          <button class="ctrl-action-btn"
            @click=${()=>this._svc("button","press",r.FLASH_LIGHTS)}>
            <span class="icon">${d(l["flash-lights"])}</span>
            <span>Flash</span>
          </button>
          <button class="ctrl-action-btn"
            @click=${()=>this._svc("button","press",r.HORN)}>
            <span class="icon">${d(l.horn)}</span>
            <span>Horn</span>
          </button>
          <button class="ctrl-action-btn"
            @click=${()=>this._svc("button","press",r.REMOTE_START)}>
            <span class="icon">${d(l["remote-start"])}</span>
            <span>Start</span>
          </button>
          <button class="ctrl-action-btn"
            @click=${()=>this._svc("cover",p?"close_cover":"open_cover",r.WINDOWS_COVER)}>
            <span class="icon">${d(p?l["vent-close"]:l["vent-open"])}</span>
            <span>${p?"Close":"Vent"}</span>
          </button>
        </div>
      </div>
    `}};customElements.define("tesla-menu-controls",Nt);var Ht=class extends x{static get properties(){return{selected:{type:String},available:{type:Array},showBack:{type:Boolean},customH:{type:Number},customS:{type:Number},slideFrom:{type:String,reflect:!0,attribute:"slide-from"},_showCustom:{state:!0},_hue:{state:!0},_sat:{state:!0}}}static get styles(){return k`
      :host {
        display: block;
      ...
      <div class="picker-overlay" @click=${this._onOverlayClick}>
        <div class="picker-panel">
          ...
          <div class="picker-swatches">
            ${pt.map(s=>{let i=t.includes(s.dir),a=this.selected===s.dir;return c`
                <button
    ...
    `}};customElements.define("tesla-colour-picker",Ht);var Ut=class extends x{static get properties(){return{model:{type:String},variant:{type:String},slideFrom:{type:String,reflect:!0,attribute:"slide-from"}}}static get styles(){return k`
      :host {
        display: block;
        font-family: system-ui, -apple-system, sans-serif;
      }
            ...
            ${R.map(t=>c`
              <div class="model-section">
                ...
                <div class="model-group">
                  ${t.variants.map(e=>{let s=e.id===this.variant,a=e.colours.length>1||e.colours[0]!=="neutral"||s;return c`
                      <button class="model-item${s?" selected":""}${a?"":" unavailable"}"
                        @click=${a?()=>this._select(t.id,e.id):null}>
                        <span class="model-icon">
                          <span class="icon">${d(l.car)}</span>
                        </span>
                        <span class="model-label">${e.label}</span>
                        ${a?"":c`<span class="model-no-images">no images</span>`}
                        ${s?c`
                          <span class="model-check">
                            <span class="icon">${d(l.check)}</span>
                          </span>`:""}
                      </button>`})}
                </div>
              </div>
    ...
    `}};customElements.define("tesla-model-picker",Ut);var Je=["chargeport","frunk","fr","ff","nr","nf"],ve={"nf+nr":"nf-nr-combined-overlay.png","ff+fr":"ff-fr-combined-overlay.png"},ts=["frunk","nf","nr","fr"],xe={"nf+nr":"oncharge-nf-nr-combined-overlay.png"},es="tesla-card-colour-",ss="tesla-card-model-",is="tesla-card-layout-",as="tesla-card-size-",ke=["small","medium","large"],U=class U extends x{static get properties(){return{hass:{type:Object},config:{type:Object},_menu:{state:!0},_imageError:{state:!0},_settingsView:{state:!0},_modelOverride:{state:!0},_colourOverride:{state:!0},_layout:{state:!0},_settingsSlide:{state:!0},_cardSize:{state:!0}}}static get styles(){return[O,be]}constructor(){super(),this._menu=null,this._imageError=!1,this._settingsView=null,this._modelOverride=null,this._colourOverride=null,this._layout="portrait",this._settingsSlide=null,this._cardSize="medium",this._baseConfig=null,this._combinedAvail={},this._onchargeAvail=!1,this._cableAvail=!1,this._toggleCharger=()=>this._toggle("charger"),this._toggleClimate=()=>this._toggle("climate"),this._toggleControls=()=>this._toggle("controls"),this._handleCloseMenu=()=>{this._menu=null},this._handleColourChanged=t=>this._onColourChanged(t),this._handleModelChanged=t=>this._onModelChanged(t),this._handleModelBack=()=>{this._settingsSlide=null,this._settingsView="main"},this._handleColourBack=()=>{this._settingsSlide="left",this._settingsView="model"},this._handlePickerClose=()=>{this._settingsView=null,this._settingsSlide=null}}setConfig(t){if(!t.car_name)throw new Error("car_name is required");this._baseConfig={car_model:"3",car_variant:"3.1",car_color:"neutral",image_path:"/hacsfiles/homeassistant-fe-tesla",show_speed:!0,...t},this._applyConfig()}_applyConfig(){let t={...this._baseConfig};this._modelOverride&&(t.car_model=this._modelOverride.model,t.car_variant=this._modelOverride.variant);let e=this._colourOverride;e&&(t.car_color=e.dir==="custom"?"neutral":e.dir),this.config=t,this._preloadCombinedOverlays()}_preloadCombinedOverlays(){for(let[s,i]of Object.entries(ve)){let a=new Image;a.onload=()=>{this._combinedAvail[s]=!0,this.requestUpdate()},a.onerror=()=>{this._combinedAvail[s]=!1},a.src=this._overlayUrl(i)}let t=new Image;t.onload=()=>{this._onchargeAvail=!0,this.requestUpdate()},t.onerror=()=>{this._onchargeAvail=!1},t.src=this._overlayUrl("oncharge-base.png");let e=new Image;e.onload=()=>{this._cableAvail=!0,this.requestUpdate()},e.onerror=()=>{this._cableAvail=!1},e.src=this._overlayUrl("oncharge-cable-overlay.png");for(let[s,i]of Object.entries(xe)){let a=new Image;a.onload=()=>{this._combinedAvail["oc_"+s]=!0,this.requestUpdate()},a.onerror=()=>{this._combinedAvail["oc_"+s]=!1},a.src=this._overlayUrl(i)}}static getConfigElement(){return document.createElement("tesla-card-editor")}static getStubConfig(){return{car_name:"",car_model:"3",car_variant:"3.1",car_color:"neutral",image_path:"/hacsfiles/homeassistant-fe-tesla"}}connectedCallback(){super.connectedCallback(),this._baseConfig&&(this._restoreModel(),this._restoreColour()),this._restoreLayout(),this._restoreSize()}_colourLsKey(){return es+(this._baseConfig?.car_name??"default")}_restoreColour(){try{let t=localStorage.getItem(this._colourLsKey());if(!t)return;try{this._colourOverride=JSON.parse(t)}catch{this._colourOverride={dir:t}}this._applyConfig()}catch{}}_persistColour(){try{this._colourOverride?localStorage.setItem(this._colourLsKey(),JSON.stringify(this._colourOverride)):localStorage.removeItem(this._colourLsKey())}catch{}}_onColourChanged(t){let e=t.detail;e?e.dir==="custom"?this._colourOverride={dir:"custom",h:e.h,s:e.s}:this._colourOverride={dir:e.dir}:this._colourOverride=null,this._applyConfig(),this._persistColour(),this._imageError=!1}_modelLsKey(){return ss+(this._baseConfig?.car_name??"default")}_restoreModel(){try{let t=localStorage.getItem(this._modelLsKey());t&&(this._modelOverride=JSON.parse(t),this._applyConfig())}catch{}}_persistModel(){try{this._modelOverride?localStorage.setItem(this._modelLsKey(),JSON.stringify(this._modelOverride)):localStorage.removeItem(this._modelLsKey())}catch{}}_onModelChanged(t){let{model:e,variant:s}=t.detail;this._modelOverride={model:e,variant:s};let i=this._colourOverride;i&&i.dir!=="custom"&&(Ot(e,s).includes(i.dir)||(this._colourOverride=null,this._persistColour())),this._applyConfig(),this._persistModel(),this._imageError=!1,this._settingsSlide="right",this._settingsView="colour"}_layoutLsKey(){return is+(this._baseConfig?.car_name??"default")}_restoreLayout(){try{localStorage.getItem(this._layoutLsKey())==="landscape"&&(this._layout="landscape")}catch{}}_persistLayout(){try{localStorage.setItem(this._layoutLsKey(),this._layout)}catch{}}_toggleLayout(){this._layout=this._layout==="landscape"?"portrait":"landscape",this._persistLayout()}_sizeLsKey(){return as+(this._baseConfig?.car_name??"default")}_restoreSize(){try{let t=localStorage.getItem(this._sizeLsKey());t&&ke.includes(t)&&(this._cardSize=t)}catch{}}_persistSize(){try{localStorage.setItem(this._sizeLsKey(),this._cardSize)}catch{}}_setCardSize(t){this._cardSize!==t&&(this._cardSize=t,this._persistSize())}_imgUrl(t){let{image_path:e,car_model:s,car_variant:i,car_color:a}=this.config;return`${e}/${s}/${i}/${a}/${t}?v=${U._imgVer}`}_overlayUrl(t){let{image_path:e,car_model:s,car_variant:i,car_color:a}=this.config;return`${e}/${s}/${i}/${a}/overlays/${t}?v=${U._imgVer}`}_btnUrl(t){return`${this.config.image_path}/buttons/${t}?v=${U._imgVer}`}get _customColour(){let t=this._colourOverride;return!t||t.dir!=="custom"?null:{h:t.h,s:t.s}}get _hasCustomOverlay(){let t=this._customColour;return!!t&&t.s>0}_maskUrl(t){let{image_path:e,car_model:s,car_variant:i}=this.config,a=t.replace(".png","-mask.png");return`${e}/${s}/${i}/neutral/${a}?v=${U._imgVer}`}_customOverlayStyleFor(t){let e=this._customColour;if(!e||e.s===0)return"";let s=this._maskUrl(t);return`position:absolute;inset:0;pointer-events:none;background:hsl(${e.h},${e.s}%,50%);mix-blend-mode:color;-webkit-mask-image:url(${s});mask-image:url(${s});-webkit-mask-size:contain;mask-size:contain;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center;`}_eid(t){return dt(t,this.config.car_name)}_state(t){return this.hass?.states[this._eid(t)]}_val(t){return this._state(t)?.state}_attr(t,e){return this._state(t)?.attributes?.[e]}async _svc(t,e,s,i={}){try{await this.hass.callService(t,e,{entity_id:this._eid(s),...i})}catch(a){console.error("[tesla-card] service error",t,e,a)}}_toggle(t){this._menu=this._menu===t?null:t}_openSettings(){this._settingsView="main",this._settingsSlide=null}_openModelPicker(){this._settingsView="model",this._settingsSlide=null}_closeSettings(){this._settingsView=null,this._settingsSlide=null}_onSettingsOverlayClick(t){t.target===t.currentTarget&&this._closeSettings()}render(){if(!this.config||!this.hass)return c``;let t=this._menu,e=this._colourOverride,s=this._val(r.BATTERY_LEVEL),i=s!=null?Math.round(Number(s)):null,a=i!=null?Math.max(0,Math.min(100,i)):0,o=a>=50?"high":a>=20?"medium":"low",p=this._val(r.BATTERY_RANGE),h=this._attr(r.BATTERY_RANGE,"unit_of_measurement")??"km",g=p!=null?`${Math.round(Number(p))} ${h}`:null,m=this._val(r.CHARGING)==="on",u=this._val(r.ONLINE)==="on",b=this._state(r.ONLINE),v=this._val(r.FRUNK_COVER)==="open"||this._val(r.FRUNK)==="on",y=this._val(r.TRUNK)==="on",G=this._val(r.PLUGGED_IN)==="on",z=this._val(r.CHARGER_DOOR)==="open"||G,w={nf:this._attr(r.DOORS,"driver_front")===!0,nr:this._attr(r.DOORS,"driver_rear")===!0,ff:this._attr(r.DOORS,"passenger_front")===!0,fr:this._attr(r.DOORS,"passenger_rear")===!0},$=G&&this._onchargeAvail,E=$?"oncharge-":"",L=y?`${E}trunk-open.png`:`${E}base.png`,et=$?ts:Je,P={frunk:v,nf:w.nf,nr:w.nr,fr:w.fr};$||(P.chargeport=z,P.ff=w.ff);let ut=$?"oc_nf+nr":"nf+nr",Pt=w.nf&&w.nr&&this._combinedAvail[ut],st=!$&&w.ff&&w.fr&&this._combinedAvail["ff+fr"],D=$?xe:ve,it=[],Dt=!1,Bt=!1;for(let f of et)if(P[f]){if((f==="nf"||f==="nr")&&Pt){Dt&&it.push(D["nf+nr"]),Dt=!0;continue}if((f==="ff"||f==="fr")&&st){Bt&&it.push(D["ff+fr"]),Bt=!0;continue}it.push(`${E}${f}-overlay.png`)}let mt=this._val(r.DOOR_LOCK),at=mt==="locked",we=this._val(r.CHARGING_STATE)??"\u2014",ye=this._val(r.CHARGE_RATE),$e=this._attr(r.CHARGE_RATE,"unit_of_measurement")??"kW",gt=this._val(r.CLIMATE),Qt=gt!=null&&gt!=="off"&&gt!=="unavailable",jt=this._attr(r.CLIMATE,"temperature"),Ae=this._attr(r.CLIMATE,"temperature_unit")??"\xB0C",Ce=jt!=null?Number(jt).toFixed(1):"\u2014",Gt=!u&&b?"Asleep":this._val(r.PARKING_BRAKE)==="on"?"Parked":(()=>{if(!this.config.show_speed)return null;let f=this._attr(r.LOCATION,"speed");return f!=null&&Number(f)>0?`${Math.round(Number(f))} km/h`:null})(),Ee=m?`Charging \xB7 ${ye??"\u2014"} ${$e}`:G?"Plugged in":we,Se=Qt?`${Ce}${Ae}`:"Off",Ft=mt?at?"Locked":"Unlocked":null,ft=this._val(r.LOCATION),Vt=ft?ft.charAt(0).toUpperCase()+ft.slice(1).replace(/_/g," "):null,Me=this._val(r.SENTRY_MODE)==="on",_t=R.find(f=>f.id===this.config.car_model),Kt=_t?.variants.find(f=>f.id===this.config.car_variant),Oe=_t&&Kt?`${_t.name} \xB7 ${Kt.label}`:this.config.car_model,qt=e?.dir==="custom",Re=qt?null:pt.find(f=>f.dir===this.config.car_color),Te=qt?"Custom":Re?.name??this.config.car_color,Le=Ot(this.config.car_model,this.config.car_variant),Ie=this._layout==="landscape",Ne=this._cardSize!=="medium"?`size-${this._cardSize}`:"";return c`
      <ha-card class="${Ie?"landscape":""} ${Ne}">
          ...
          <div class="header">
            <div class="header-left">
              <div class="car-name-row">
                ...
                <span class="icon name-chevron">${d(l["chevron-down"])}</span>
              </div>
              ...
              ${Gt?c`<span class="status-text">${Gt}</span>`:""}
            </div>
            <div class="header-right">
              <button class="icon-btn" title="Settings"
                @click=${()=>this._openSettings()}>
                <span class="icon">${d(l.settings)}</span>
              </button>
              <button class="icon-btn" title="Refresh"
                @click=${()=>this._svc("button","press",r.FORCE_UPDATE)}>
                <span class="icon">${d(l.refresh)}</span>
              </button>
            </div>
          </div>
        `}
          ...
          <div class="landing-body">
            <div class="landing-left">
              ...
              <div class="quick-actions">
                ${mt?c`
                  <button class="quick-btn ${at?"q-locked":"q-unlocked"}"
                    @click=${()=>this._svc("lock",at?"unlock":"lock",r.DOOR_LOCK)}>
                    <span class="icon">${d(at?l.lock:l.unlock)}</span>
                ...
                <button class="quick-btn ${Qt?"q-active":""}" @click=${this._toggleClimate}>
                  <span class="icon">${d(l["climate-fan"])}</span>
                </button>
              </div>
            </div>
            <div class="nav-rows">
              <button class="nav-row"
                ...
                <span class="icon nav-icon">${d(l.car)}</span>
                <div class="nav-text">
                  <span class="nav-label">Controls</span>
                  ${Ft?c`<span class="nav-sublabel">${Ft}</span>`:""}
                </div>
                <span class="icon nav-chevron">${d(l["chevron-right"])}</span>
              </button>
              <button class="nav-row"
                @click=${this._toggleClimate}>
                <span class="icon nav-icon">${d(l["climate-fan"])}</span>
                <div class="nav-text">
                  <span class="nav-label">Climate</span>
                  <span class="nav-sublabel">${Se}</span>
                </div>
                <span class="icon nav-chevron">${d(l["chevron-right"])}</span>
              </button>
              <button class="nav-row" disabled>
                <span class="icon nav-icon">${d(l.location)}</span>
                <div class="nav-text">
                  <span class="nav-label">Location</span>
                  ${Vt?c`<span class="nav-sublabel">${Vt}</span>`:""}
                </div>
                <span class="icon nav-chevron">${d(l["chevron-right"])}</span>
              </button>
              <button class="nav-row"
                @click=${this._toggleCharger}>
                <span class="icon nav-icon">${d(l["charge-bolt"])}</span>
                <div class="nav-text">
                  <span class="nav-label">Charging</span>
                  <span class="nav-sublabel">${Ee}</span>
                </div>
                <span class="icon nav-chevron">${d(l["chevron-right"])}</span>
              </button>
              <button class="nav-row" disabled>
                <span class="icon nav-icon">${d(l.schedule)}</span>
                <div class="nav-text">
              ...
              <button class="nav-row" disabled>
                <span class="icon nav-icon">${d(l.security)}</span>
                <div class="nav-text">
                  <span class="nav-label">Security & Drivers</span>
                  <span class="nav-sublabel">${Me?"Sentry Mode active":"Phone key disconnected"}</span>
                </div>
                <span class="icon nav-chevron">${d(l["chevron-right"])}</span>
              </button>
            </div>
        ...
        ${this._settingsView==="main"?c`
          <div class="settings-overlay"
            @click=${f=>this._onSettingsOverlayClick(f)}>
            <div class="settings-panel">
              ...
              <div class="settings-rows">
                <button class="settings-row"
                  ...
                  <span class="icon settings-row-icon">${d(l.car)}</span>
                  <div class="settings-row-text">
                    <span class="settings-row-label">Model & Colour</span>
                    <span class="settings-row-sub">${Oe} · ${Te}</span>
                  </div>
                  <span class="icon settings-row-chevron">${d(l["chevron-right"])}</span>
                </button>
                <div class="settings-row settings-row-static">
                  <span class="icon settings-row-icon">${d(l.resize)}</span>
                  <div class="settings-row-text">
                    <span class="settings-row-label">Card Size</span>
                  </div>
                  <div class="settings-size-control">
                    ${ke.map(f=>c`
                      <button class="settings-size-btn${this._cardSize===f?" selected":""}"
                        @click=${He=>{He.stopPropagation(),this._setCardSize(f)}}>
                ...
                <button class="settings-row"
                  ...
                  <span class="icon settings-row-icon">${d(l.layout)}</span>
                  <div class="settings-row-text">
